...
- H7–H12 TP×{pandora,golden-crown,diane,kevin,adambell,plmk} α0.75 all **INVALID** band
  (×2.21/1.97/1.85/1.98/1.87/2.02); even gate-valid near-miss B at 25% sabotages baseline — no α0.85.
