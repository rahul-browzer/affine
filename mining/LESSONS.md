...
- F6 a1: ghost ENOENT on hash **absent from 16-so local king seed** (`6YKNXZRS…`); peer mid-load rsync from a pod whose chall already hit :8002=200 (F7 iso king, 19 so) before a2 profile_run (p385).
