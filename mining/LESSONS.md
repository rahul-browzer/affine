...
- **Raw past-king/genesis REFUTED (kevin+pandora+diane+af-k1+TalentPigs+genesis+golden+Bittob):** F19−0.006…**F23−0.084**. Raw left: everest12 (F22). **Full-FT×high-Λ2 class dying/closed:** Tok F26 −0.000; Genesis F27 −0.071; Bittob F31 −0.077; Tok-refs F28 −0.010; kevin F30 −0.019; pandora F33 −0.022; everest F35 −0.084; **golden F29 m=−0.09256** λ2_c=−0.029 (p498). Screens left: TalentPigs/diane/af-k1 only — do not rent more of this class.
