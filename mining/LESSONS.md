...
- **R11 REFUTE** p2175 m=−0.0055; **R2bm REFUTE** p2176 m=−0.0057 z=−1.49 hr−0.74× (`tttt…guass` vs ckp333) — Stage-5 SKIP; copy dec→`affine_data` so R9 gate sees it; queue thru 00521 screened; warm-arm R12 BoN-CE.
