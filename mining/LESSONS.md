...
- **R2ao REFUTE** af17 −0.074×; **R2ap WEAK_SKIP** h44 0.327× → R2aq now; **R2aw SKIP_UNSERVABLE** mt1 = `Glm4MoeForCausalLM` (not Qwen VLM) — Hub-inspect arch before ~60 GiB prefetch.
