...
- **Never freeze chall after a single `hi` probe** — short-only freeze → Triton ENOENT mid-n80 (p251/OV4T43); always d1–d4 diverse writable warm first (cuda403 omitted this; p404/p405).
