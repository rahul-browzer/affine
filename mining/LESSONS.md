...
- **R9 graft** `.clone()` visuals (p2187); kill chall before serve-dir rewrite (p2189). **R9/R12/R13/R3b/R14 REFUTE** (p2188–94). H135 `post_train` defaults BASE=kevin — non-kevin warm-arms must `export BASE=` (R16 p2194).
