...
- HF snapshot "ready" ≠ complete: index before shards → vLLM "weights not initialized" (p2106). **ec08 + ckp55 UNSERVABLE** even with full shards + index≡king **and** HF repo+rev serve (p2116–2118) — skip parent; never `cp` through HF blob symlinks.
