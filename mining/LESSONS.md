...
- recover264 DONE rearms form+n80 only (not preempt/mid304). Match `$0` via `/proc/*/cmdline` (H82/H93). Seed chall from **live king isolated TCACHE** (H91/p382); clone: `test -x` rearm (H94); king cold-JIT→peer king TCACHE (H95).
