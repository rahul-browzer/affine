...
- Before LoRA merge into a path still served as chall (`rm -rf $MERGED` while :8002 holds it): **kill chall by pidfile first** — frees GPUs 4–5 and avoids mmap/delete races; p2149 R6b stale pid55409 cleared mid-save → clean re-serve.
