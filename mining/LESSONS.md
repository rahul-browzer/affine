...
- H7–H11 TP×{pandora,golden-crown,diane,kevin,adambell} α0.75 all **INVALID** band
  (×2.21/1.97/1.85/1.98/1.87); even gate-valid near-miss B at 25% sabotages baseline — no α0.85.
