...
- R3 GRPO wedges on CLOSE-WAIT to teacher:8000 (log freeze; 0%CPU / futex) even with healthy `/v1/models` — kill-by-PID + `start_r3.sh` (p2063@step10, p2070@step30→pid26401 step1 mean_r0.019).
