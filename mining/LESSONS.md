...
- Host fleet restart: never \`pgrep/pkill -f wait_fleet_b300\` in the same shell that launches it — the pattern matches the launcher cmdline and kills the new waiter (p2130).
