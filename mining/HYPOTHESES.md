...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — R2/R2b/R2c SKIPPED; **R2d** pure awesome n80 **RUNNING**; R2e Δ=**0.626** waits |
...
- **Status:** open. Weak Tok×awesome lanes SKIPPED. After R1c refute, **R2d** pure awesome-v6 chall reload+n80 **RUNNING** (pid 106493); **R2e** Talent×awesome (Δ=0.626) waits (pid 104742). Dir: `experiments/r2-multiking-merge/`.
