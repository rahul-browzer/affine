...
| 2 | H2 | very high (almost free compute) | merge margin vs kevin **> 0.02** first try; target **> 0.04** | α=0.5 **missed** (−0.010); α=0.65 merge DONE, sim launching |
...
- **α=0.65 merge (2026-08-07T00:48:53Z):** DONE — 1026 keys merged, 19 from A,
  ...
  Re-serve+sim pipeline pid 71925 → `/root/affine_data/h2_kp65_sim_result.json`.
