...
| # | id | claim | status |
|---|---|---|---|
| 1 | R1 | Teacher-ref SFT / distill on current king init raises Reason margin > 3·SE | **open** — first screen on `mine-crown-1` |
...
- **Status:** open. Needs crown-pod sim.
- **Dir:** `experiments/r1-reason-distill/` (create on launch).
