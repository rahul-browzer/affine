...
- **Status:** open. **R2d** 0.22×; many Talent-skew REFUTEs (e/g/h/q/t/l/n/o/p/r/ab/ac/ad/**am −1.39×**). **R2an SKIP_BOARD** cp13. **R2ao REFUTE** pure af17 hr **−0.074×** (n=80). **R2ap** pure-h44 n80 ~21/80; **R2aq** wait; **R2ar** iynocr2p (490) + hope11 (491) DONE prefetch; **R2as** pure 726 (492) watch+prefetch armed. Watch 485–492. **R2ak** local 0.641×. Dir: `experiments/r2-multiking-merge/`.
