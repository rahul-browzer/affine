...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e/g/h/q/t/l/n/o/p/r REFUTE**; **R2ag REFUTE −0.52×**; **R2j/i/k SKIP**; **R2s/R2u WEAK_SKIP**; **R2v** 0.39×; **R2w** board-skip 0.40×; **R2ae SKIP_GATED**; **R2af/R2x SKIP_BOARD** v8; **R2y SKIP_UNSERVABLE**; **R2ah/R2z SKIP_BOARD** v9 hr0.21×; **R2ai RESET**; **R2aj** pure-sky armed (wait warm+469); **R2aa–ad** wait 469–471 |
...
- **Status:** open. Weak Tok/kevin×awesome / saysth×awesome / **saysth×kevin** lanes SKIPPED (Δ≪0.01). **R2d** hr **0.22×**. **R2e/g/h/q/t/l/n/o/p/r REFUTED**. **R2ag** pure tpc9 **REFUTE −0.52×** (p1992). **R2j/i/k SKIPPED**. **R2s/R2u WEAK_SKIP**. **R2v** pure sft3 local hr **0.39×**. **R2w** asdf **SKIP_BOARD** 0.40×. **R2ae** sth **SKIP_GATED**. **R2af/R2x SKIP_BOARD** v8. **R2y SKIP_UNSERVABLE** (463). **R2ah/R2z SKIP_BOARD** chal-00467 v9 hr **0.21×**. **R2ai SKIP_BOARD** chal-00468 sbs hr **0.018×** (pod also RESET). **R2aj** pure sky (`magicworld7/…-sky@a569e29b`) armed on new crown (wait warm+board hr≥1.5×). **R2aa–ad** wait 469–471 Reason+. Dir: `experiments/r2-multiking-merge/`.
