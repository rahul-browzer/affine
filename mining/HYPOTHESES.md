...
|---|---|---|---|---|
| 1 | H124/F29 | high | golden full-FT → m>+0.015 | **open** (n80 ~69/80) |
| 2 | H127/F32 | high | TalentPigs full-FT → m>+0.015 | **open** (n80 ~15/80) |
| 3 | H117/F22 | high | raw everest12 (no LoRA) → m>+0.015 | **open** (n80 ~14/80) |
| 4 | H128/F33 | high | pandora full-FT → m>+0.015 | **open** (n80 ~21/80) |
| 5 | H129/F34 | high | diane full-FT → m>+0.015 | **open** (n80 ~8/80) |
| 6 | H130/F35 | high | everest full-FT → m>+0.015 | **open** (king478 loading) |
| 7 | H131/F36 | high | af-k1 full-FT → m>+0.015 | **open** (train/post_train) |
