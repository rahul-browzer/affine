...
|---|---|---|---|---|
| 1 | H1v2 | highest (fixes H1 envelope) | thought-only SFT → r∈[0.70,0.85] + margin **> 0.04** | open — **training** step28/55 loss0.381; pipe **167913**; pass58 teardown/n80-wait/meta fixes |
