...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e/g/h/q/t/l/n/o REFUTE**; **R2j/i/k SKIP**; **R2s/R2u WEAK_SKIP**; **R2v** 0.39×; **R2w** board-skip 0.40×; **R2p** Talent×sth **n80~2/80** Δ0.671 (board 455 hr **0.79×**); **R2x** eager Δ0.626 (wait 462); **R2y** eager Δ0.622 (wait 463); **v9** prefetch armed (chal467) |
