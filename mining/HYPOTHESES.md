...
|---|---|---|---|---|
| 1 | H6 | highest | TalentPigs-init shortz-nolist thought LoRA lr5e-6 → clip-L1≥0.042, margin>0.04 | **open** (train~50/99; mid50 merging) |
| 2 | H7 | high (cheap) | TalentPigs×pandora α0.75 → margin>0.04 vs TalentPigs | **open** (n80 ~43/80) |
| 3 | H8 | high (cheap) | TalentPigs×golden-crown α0.75 → margin>0.04 vs TalentPigs | **open** (n80 ~34/80) |
| 4 | H9 | high (cheap) | TalentPigs×diane613 α0.75 → margin>0.04 vs TalentPigs | **open** (mine-h9-1 boot) |
...
- **Status:** train **RUNNING** ~50/99 loss≈0.524; mid50 **MERGING** (ckpt-50→n40 on 4,5); pipe waiting. Detail: `experiments/s4-h6-talentpigs-shortz-mild/`.
...
- **Status:** merge OK_NON_IDENT; n80 **RUNNING** ~43/80. Detail: `experiments/s4-h7-tp-pandora-merge/`.
...
- **Status:** merge OK_NON_IDENT; n80 **RUNNING** ~34/80. Detail: `experiments/s4-h8-tp-goldencrown-merge/`.
