...
- Unmodified TalentPigs @dbfbb3e2 vs Tok → m>+0.015 (≠F10 LoRA). Bootstrap p440. `s4-h113-f18-raw-talentpigs/`.

### H105/F10 — TalentPigs × high-Λ2
- TalentPigs + 1059 high-Λ2 → m>+0.015. n80 ~13/80. `s4-h105-f10-talentpigs-base/`.

### H106/F11 — pandora × high-Λ2
- pandora @5218b138 + high-Λ2 → m>+0.015. n80 ~18/80. `s4-h106-f11-pandora-base/`.

### H108/F13 — diane613 × high-Λ2
- diane613 @ad0f3f11 + high-Λ2 → m>+0.015. n80 ~32/80. `s4-h108-f13-diane613/`.

### H109/F14 — Bittob × high-Λ2
- Bittob11040 @0c04fe92 + high-Λ2 → m>+0.015. n80 ~16/80. `s4-h109-f14-bittob/`.

### H110/F15 — everest12 × high-Λ2
- everest12 @a5ac5311 + high-Λ2 → m>+0.015. n80 ~17/80. `s4-h110-f15-everest12/`.
