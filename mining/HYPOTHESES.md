...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e REFUTE**; **R2f SKIP**; **R2h TTK REFUTE**; **440 saysth** hr=0.73×; **R2g** Talent×saysth merge RUNNING; **R2i** wait 441; **BKN** watch 432 |
...
- **Status:** open. Weak Tok/kevin×awesome lanes SKIPPED (Δ≪0.01). **R2d** hr **0.22×**. **R2e** Talent×awesome **REFUTED** (hr −1.18×). **R2f** WEAK_SKIP. **R2h** Tok×Talent×kevin equal-α **REFUTED** (hr −0.59×). **chal-00440 saysth** recomputed Reason margin **+0.00916** (z=2.18, hr **0.73×**, n=80) — Reason+ / below crown; ungated **R2g** Talent0.25×saysth0.75 CPU merge (running). **R2i** still gated on 441 Reason+. **BKN seven** watch **140530**. Dir: `experiments/r2-multiking-merge/`.
