...
|---|---|---|---|---|
| 1 | H5b | highest now | TalentPigs-init thought-only LoRA (lr=1e-5) → margin **> 0.04** | **open** — n80 **RUNNING** pid **276121** (king47/chall47 @09:07Z; ETA~09:24Z @~1.94tpm); pipe **266631**; harvest **1964910** |
