...
|---|---|---|---|---|
| 1 | H39 | high | H28 cell @ **lr=3e-5** → m>0.04 | **open** (n80 ~30/80) |
| 2 | H40 | high | H28 cell @ **epochs=3** → m>0.04 | **open** (chall p214) |
| 3 | H41 | med | H28 cell @ **lora r=32** → m>0.04 | **open** (chall p214) |
| 4 | H42 | med | H28 cell @ **lr=5e-6** → m>0.04 | **open** (training) |
| 5 | H43 | med | H28 cell @ **α=64 r16** → m>0.04 | **open** (training) |
