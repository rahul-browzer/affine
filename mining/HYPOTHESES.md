...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2bk REFUTE** m=+0.0004 z=0.13 vs ckp333 (p2160); **R2bl** Bittoby :8002→n80 |
...
| 7 | R7 | High-Reason data-filter curriculum FT | **open — live** · train DONE; TKC serving; n80 watcher→ckp333 (p2160) |
