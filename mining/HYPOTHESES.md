...
| 3 | R3 | Directly optimize / RL a reward = Reason (teacher lp delta) | **open — PRIORITY** · pod `mine-r3-grpo-1` 8×B300 rented p2054; bootstrap next |
...
- **Status:** open — **pod online** `mine-r3-grpo-1` (golden-hawk-ff, 8×B300 @$64/h). Plan: `experiments/r3-reason-grpo/`. Next = bootstrap + adapt H132 `train_rl_l2.py` for Reason GRPO.
