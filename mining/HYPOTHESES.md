...
| 3 | H114/F19 | high | raw kevin954 (no LoRA) → m>+0.015 | **open** (bootstrap p441) |
| 4 | H105/F10 | high | TalentPigs × high-Λ2 → m>+0.015 | **open** (n80 ~22/80) |
| 5 | H106/F11 | high | pandora × high-Λ2 → m>+0.015 | **open** (n80 ~30/80) |
| 6 | H108/F13 | high | diane613 × high-Λ2 → m>+0.015 | **open** (n80 ~42/80) |
| 7 | H109/F14 | high | Bittob11040 × high-Λ2 → m>+0.015 | **open** (n80 ~26/80) |
| 8 | H110/F15 | high | everest12 × high-Λ2 → m>+0.015 | **open** (n80 ~32/80) |
| 9 | H111/F16 | high | af-k1 × high-Λ2 → m>+0.015 | **open** (train) |
...
- Unmodified kevin954 @3fb79cfb vs Tok → m>+0.015 (≠F9 LoRA). Bootstrap p441. `s4-h114-f19-raw-kevin/`.

### H105/F10 — TalentPigs × high-Λ2
- TalentPigs + 1059 high-Λ2 → m>+0.015. n80 ~22/80. `s4-h105-f10-talentpigs-base/`.

### H106/F11 — pandora × high-Λ2
- pandora @5218b138 + high-Λ2 → m>+0.015. n80 ~30/80. `s4-h106-f11-pandora-base/`.

### H108/F13 — diane613 × high-Λ2
- diane613 @ad0f3f11 + high-Λ2 → m>+0.015. n80 ~42/80. `s4-h108-f13-diane613/`.

### H109/F14 — Bittob × high-Λ2
- Bittob11040 @0c04fe92 + high-Λ2 → m>+0.015. n80 ~26/80. `s4-h109-f14-bittob/`.

### H110/F15 — everest12 × high-Λ2
- everest12 @a5ac5311 + high-Λ2 → m>+0.015. n80 ~32/80. `s4-h110-f15-everest12/`.
...
| — | next raw-base | pandora / diane unmodified |
