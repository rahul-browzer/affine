...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e/g/h/q/t/l/n/o/p/r REFUTE**; **R2ag REFUTE −0.52×**; **R2ab REFUTE −1.59×**; **R2ac REFUTE −0.978×**; **R2j/i/k SKIP**; **R2s/R2u WEAK_SKIP**; **R2v** 0.39×; **R2w** board-skip 0.40×; **R2ae SKIP_GATED**; **R2af/R2x SKIP_BOARD** v8; **R2y SKIP_UNSERVABLE**; **R2ah/R2z SKIP_BOARD** v9 hr0.21×; **R2ai RESET**; **R2aj SKIP_BOARD** sky hr0.459×; **R2ak** local **0.641×** / board470 **0.094×**; **R2al SKIP_BOARD** 471 hr**0.580×**; **R2ad** Talent×pig loading; **R2am** DONE+armed Δ0.671 (480 hr**0.503×**); **R2an** weights Δ0.626 wait481; **R2aa** stubbed |
...
- **Status:** open. Weak Tok/kevin×awesome / saysth×awesome / **saysth×kevin** lanes SKIPPED (Δ≪0.01). **R2d** hr **0.22×**. **R2e/g/h/q/t/l/n/o/p/r REFUTED**. **R2ag** pure tpc9 **REFUTE −0.52×** (p1992). **R2ab** Talent×sky **REFUTE −1.59×** (p2017). **R2ac** Talent×google **REFUTE −0.978×** (p2021; m−0.031 z−2.94 n80) despite R2ak local 0.641× — Stage-5 SKIP; google blend purged. **R2j/i/k SKIPPED**. **R2s/R2u WEAK_SKIP**. **R2v** pure sft3 local hr **0.39×**. **R2w** asdf **SKIP_BOARD** 0.40×. **R2ae** sth **SKIP_GATED**. **R2af/R2x SKIP_BOARD** v8. **R2y SKIP_UNSERVABLE** (463). **R2ah/R2z SKIP_BOARD** chal-00467 v9 hr **0.21×**. **R2ai SKIP_BOARD** chal-00468 sbs-v0 hr **0.018×**. **R2aj SKIP_BOARD** chal-00469 sky hr **0.459×**. **R2ak** pure google local hr **0.641×**; board 470 hr **0.094×**. **R2al SKIP_BOARD** 471 pig hr **0.580×**. **R2ad** Talent×pig Δ=**0.626** chall loading → n80. **R2am** Talent×sbs-v1 Δ=**0.671** (480 hr **0.503×**) waits R2ad. **R2an** Talent×cp13 weights DONE Δ=**0.626**; DONE gated on chal-00481 hr>0; n80 after R2am. **R2aa** stubbed. Dir: `experiments/r2-multiking-merge/`.
