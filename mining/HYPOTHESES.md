...
|---|---|---|---|---|
| 1 | H5c | highest now | kevin-init thought LoRA on **expanded** teacher_refs → clip-L1≥0.042, r∈[0.70,0.85], margin **> 0.04** vs TalentPigs | **open** — train **2820** step11/99; pipe **10642** (pidfile wait fix); prewarm **5206** t=1 k=0; host harvest **2090851** + deadman **2090852**@19:00Z; DATA=791 shortz |
