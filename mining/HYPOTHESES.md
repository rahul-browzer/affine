...
|---|---|---|---|---|
| 1 | H5c | highest now | kevin-init thought LoRA on **expanded** teacher_refs → clip-L1≥0.042, r∈[0.70,0.85], margin **> 0.04** vs TalentPigs | **open** — train **2820** step5/99; pipe **5222** + prewarm **5206** armed; DATA=791 shortz |
