...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e REFUTE**; **R2f SKIP**; **R2h TTK REFUTE**; **440 saysth** hr=0.73×; **R2g** Talent×saysth **n80 RUNNING**; **R2i** wait 441; **BKN seven** live 432; **BKN six** DONE; **sft3** prefetching |
