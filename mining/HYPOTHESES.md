...
|---|---|---|---|---|
| 1 | H5c | highest now | kevin-init thought LoRA on **expanded** teacher_refs → clip-L1≥0.042, r∈[0.70,0.85], margin **> 0.04** vs TalentPigs | **open** — `mine-h5c-1` rented; bootstrap→train in flight; DATA=791 shortz |
