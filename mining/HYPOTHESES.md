...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e/g/h/q/t/l/n/o REFUTE**; **R2j/i/k SKIP**; **R2s/R2u WEAK_SKIP**; **R2v** 0.39×; **R2w** board-skip 0.40×; **R2p** Talent×sth **n80~35/80** Δ0.671 (board 455 hr **0.79×**); **R2x** eager Δ0.626 (wait 462); **R2y** eager Δ0.622 (wait 463); **R2z** Talent×v9 eager **Δ0.671** (wait 467); v9/sbs DONE · **sky RUNNING** · **google-after-sky ARMED** |
...
- **Status:** open. Weak Tok/kevin×awesome / saysth×awesome / **saysth×kevin** lanes SKIPPED (Δ≪0.01). **R2d** hr **0.22×**. **R2e/g/h/q/t/l/n/o REFUTED**. **R2j/i/k SKIPPED**. **R2s/R2u WEAK_SKIP**. **R2v** pure sft3 local hr **0.39×** ≈ board 450. **R2w** pure asdf **SKIP_BOARD_FIRST** (chal-00451 hr **0.40×**). **R2l** Talent×sft3 **REFUTE** hr **−0.89×**. **R2n** Talent0.25×asdf:0.75 **REFUTE** hr **−1.07×**. **R2o** Talent×zeus **REFUTE** hr **−1.10×** (board 0.25×, Δ=0.626). **R2p** Talent×sth **n80~35/80** Δ=**0.671** (board chal-00455 hr **0.79×**). **R2x** eager Δ=**0.626** (wait 462). **R2y** eager Δ=**0.622** (wait 463). **R2z** Talent×awesome-v9 eager Δ=**0.671** (wait 467). **sbs** chal-00468 **DONE**. **sky** chal-00469 **RUNNING**. **google-after-sky ARMED** chal-00470 @9cb6484f (2×st, weights_ok). After google: 471 pig. Dir: `experiments/r2-multiking-merge/`.
