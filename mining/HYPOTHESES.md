...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e REFUTE**; **R2f SKIP**; **R2h TTK REFUTE**; **440 saysth** hr=0.73×; **R2g** ~63/80; **R2i** wait 441; **R2j** wait 432; **R2k** wait 431; **R2l** Talent×sft3 armed (450 Reason+); **cp200** DONE |
...
- **Status:** open. Weak Tok/kevin×awesome lanes SKIPPED (Δ≪0.01). **R2d** hr **0.22×**. **R2e** Talent×awesome **REFUTED** (hr −1.18×). **R2f** WEAK_SKIP. **R2h** Tok×Talent×kevin equal-α **REFUTED** (hr −0.59×). **chal-00440 saysth** hr **0.73×** — **R2g** Talent0.25×saysth0.75 **n80 ~63/80**. **R2i** gated on 441 Reason+. **R2j** Talent0.25×BKN7 0.75 wait 432. **R2k** Talent0.25×BKN6 0.75 wait 431. **R2l** Talent0.25×sft3 0.75 armed (p1923; wait 450 Reason+ then R2g/R2i/R2j/R2k lane). Prefetch: BKN six+sft3+asdf+zeus+sth+**cp200** DONE (456 queued; Talent×cp200 next). nvidia 00436 still weight-gated. Dir: `experiments/r2-multiking-merge/`.
