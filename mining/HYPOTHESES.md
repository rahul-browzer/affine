...
| 4 | H115/F20 | high | raw pandora (no LoRA) → m>+0.015 | **open** (bootstrap p442) |
| 5 | H105/F10 | high | TalentPigs × high-Λ2 → m>+0.015 | **open** (n80 ~29/80) |
| 6 | H106/F11 | high | pandora × high-Λ2 → m>+0.015 | **open** (n80 ~35/80) |
| 7 | H108/F13 | high | diane613 × high-Λ2 → m>+0.015 | **open** (n80 ~47/80) |
| 8 | H109/F14 | high | Bittob11040 × high-Λ2 → m>+0.015 | **open** (n80 ~3/80) |
| 9 | H110/F15 | high | everest12 × high-Λ2 → m>+0.015 | **open** (n80 ~38/80) |
| 10 | H111/F16 | high | af-k1 × high-Λ2 → m>+0.015 | **open** (train) |
...
- Unmodified pandora @5218b138 vs Tok → m>+0.015 (≠F11 LoRA). Bootstrap p442. `s4-h115-f20-raw-pandora/`.

### H105/F10 — TalentPigs × high-Λ2
- TalentPigs + 1059 high-Λ2 → m>+0.015. n80 ~29/80. `s4-h105-f10-talentpigs-base/`.

### H106/F11 — pandora × high-Λ2
- pandora @5218b138 + high-Λ2 → m>+0.015. n80 ~35/80. `s4-h106-f11-pandora-base/`.

### H108/F13 — diane613 × high-Λ2
- diane613 @ad0f3f11 + high-Λ2 → m>+0.015. n80 ~47/80. `s4-h108-f13-diane613/`.

### H109/F14 — Bittob × high-Λ2
- Bittob11040 @0c04fe92 + high-Λ2 → m>+0.015. n80 ~3/80. `s4-h109-f14-bittob/`.

### H110/F15 — everest12 × high-Λ2
- everest12 @a5ac5311 + high-Λ2 → m>+0.015. n80 ~38/80. `s4-h110-f15-everest12/`.
...
| F19 | raw kevin954 no-LoRA | **screening** (mine-f19-1) |
| F20 | raw pandora no-LoRA | **screening** (mine-f20-1) |
| — | next raw-base | diane unmodified |
