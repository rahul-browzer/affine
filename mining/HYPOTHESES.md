...
|---|---|---|---|---|
| 1 | H27 | high | winner-zA LoRA (TP-init) → clipL1≥0.042, m>0.04 | **open** (merge→n80) |
| 2 | H28 | high | winner-zA LoRA (**m7-init**) → m>0.04 | **open** (train ~6/51) |
| 3 | H26 | med | TP×kkk-af α0.90 → m>0.04 | **open** (n80 ~55/80) |
| 4 | H23 | low | TP×Talucampe α0.90 | **open** (king recover177) |
...
- **Status:** train DONE 18:17Z (51/51, loss≈0.50); merge save live → chall→n80.
...
- **Status:** TRAIN_LAUNCHED; ~step6/51. `s4-h28-m7-clip-l1-shape/`.

### H26 / H23
- H26 ~55/80. H23 king Triton `.so` death@probe → relaunch pass177.
