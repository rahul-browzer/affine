...
|---|---|---|---|---|
| 1 | H87 | med | **Tok-init** × winner-zA@r29 → m>0.04 | **open** (n80+mid304 ~62/80) |
| 2 | H88 | med | **Tok-init** × winner-zA@r30 → m>0.04 | **open** (n80+mid304 ~31/80) |
| 3 | H89 | med | **Tok-init** × winner-zA@r31 → m>0.04 | **open** (n80+mid304 ~44/80) |
| 4 | H90 | med | **Tok-init** × winner-zA@r14 → m>0.04 | **open** (n80+mid304 just started) |
| 5 | H91 | med | **Tok-init** × winner-zA@r12 → m>0.04 | **open** (train r12) |
...
- See archive + LESSONS. Dead: α-merge / plmk / leary / **TP×ks** / **m7×ks** /
  ...
  **α≤8∨=16∨≥64** / **clip≥0.08** / king-self / **Tok-init
  r17∨r18∨r22∨r23∨r25∨r26∨r27∨r28**. Open: **H87–H91**.
