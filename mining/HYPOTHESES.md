...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e/g/h/q/t/l/n/o/p/r REFUTE**; **R2ag REFUTE −0.52×**; **R2j/i/k SKIP**; **R2s/R2u WEAK_SKIP**; **R2v** 0.39×; **R2w** board-skip 0.40×; **R2ae SKIP_GATED**; **R2af/R2x SKIP_BOARD** v8; **R2y SKIP_UNSERVABLE**; **R2ah/R2z SKIP_BOARD** v9 hr0.21×; **R2ai RESET**; **R2aj SKIP_BOARD** sky hr0.459×; **R2ak** local **0.641×** / board470 **0.094×**; **R2al** pig n80 ~30/80; **R2ab** wait R2al; **R2ac** premerge DONE; **R2ad** EAGER Talent×pig Δ0.626 (p2010; gate 471); **R2aa** stubbed |
...
- **Status:** open. Weak Tok/kevin×awesome / saysth×awesome / **saysth×kevin** lanes SKIPPED (Δ≪0.01). **R2d** hr **0.22×**. **R2e/g/h/q/t/l/n/o/p/r REFUTED**. **R2ag** pure tpc9 **REFUTE −0.52×** (p1992). **R2j/i/k SKIPPED**. **R2s/R2u WEAK_SKIP**. **R2v** pure sft3 local hr **0.39×**. **R2w** asdf **SKIP_BOARD** 0.40×. **R2ae** sth **SKIP_GATED**. **R2af/R2x SKIP_BOARD** v8. **R2y SKIP_UNSERVABLE** (463). **R2ah/R2z SKIP_BOARD** chal-00467 v9 hr **0.21×**. **R2ai SKIP_BOARD** chal-00468 sbs hr **0.018×** (pod also RESET). **R2aj SKIP_BOARD** chal-00469 sky hr **0.459×** (p2004; no pure-sky n80). **R2ak** pure google local hr **0.641×**; board chal-00470 hr **0.094×** (p2008 gzip; lost crown) — both ≪1.5×. **R2al** pure pig n80 **RUNNING** ~30/80 (board **chal-00471** same repo). **R2ab** Talent0.25×sky0.75 premerge **DONE** Δ=**0.626** (waits R2al). **R2ac** Talent0.25×google0.75 premerge **DONE** Δ=**0.626** (waits R2ab). **R2ad** Talent0.25×pig0.75 **EAGER** p2010 (Δ=**0.626**, 70.2 GiB, identical_frac=0.45; DONE gated on 471 hr>0; waits R2ac for n80). **R2aa** stubbed. Dir: `experiments/r2-multiking-merge/`.
