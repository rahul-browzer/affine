...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** hr=0.22×; **R2e REFUTE** hr=−1.18×; **R2f SKIP**; **R2g** armed; **R2h TTK** n80 **RUNNING** (~7/80); thomp prefetch **armed** |
