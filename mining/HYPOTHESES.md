...
|---|---|---|---|---|
| 1 | H5b | highest now | TalentPigs-init thought-only LoRA (lr=1e-5) → margin **> 0.04** | **open** — n80 **RUNNING** pid **276121** (king33/chall33 @08:59Z; ETA~09:35Z @~1.30tpm); pipe **266631**; harvest **1964910** |
