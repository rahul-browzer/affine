...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e/g/h/q/t/l/n/o/p/r REFUTE**; **R2ag/ab/ac/ad REFUTE**; **R2j/i/k SKIP**; **R2s/R2u WEAK_SKIP**; **R2v** 0.39×; **R2w** board-skip 0.40×; **R2ae SKIP_GATED**; **R2af/R2x/R2ah/R2z/R2ai/R2aj/R2al SKIP_BOARD**; **R2y SKIP_UNSERVABLE**; **R2ak** local **0.641×**; **R2am** n80#2 ~30/80 + Stage-5; **R2an SKIP_BOARD** cp13 hr**0.16×**; **R2ao** pure af17 **ARMED** (prefetch DONE); h44/now DONE; **R2aa** stubbed |
...
- **Status:** open. **R2d** 0.22×; many Talent-skew REFUTEs (e/g/h/q/t/l/n/o/p/r/ab/ac/ad). **R2am** Talent×sbs-v1 n80#2 ~30/80 + Stage-5. **R2an SKIP_BOARD** (p2029) board cp13 hr **0.16×**. **R2ao** pure af17 **ARMED** wait R2am (prefetch DONE @`b7fdf6f0…`, Stage-5 armed). Prefetch h44/now/af17 DONE; watch 485/486/489. **R2ak** local 0.641×. Dir: `experiments/r2-multiking-merge/`.
