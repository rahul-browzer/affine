...
|---|---|---|---|---|
| 1 | H57 | med | H42 cell @ **lr=5.25e-6** → m>0.04 | **open** (bootstrap) |
| 2 | H55 | med | H42 cell @ **lr=5.5e-6** → m>0.04 | **open** (train+recover) |
| 3 | H56 | med | H42 cell @ **r=24** → m>0.04 | **open** (train+recover) |
| 4 | H51 | med | H28 cell @ **α=16 r16** → m>0.04 | **open** (n80 ~30/80) |
| 5 | H54 | low | H42 cell @ **lr=8e-6** → m>0.04 | **open** (merge; H50 curve weak) |
...
- **Claim:** ridge between H42 5e-6 (+0.016) and H55 5.5e-6 → m>0.04.
- **Status:** mine-h57-1 eager-shark-95 bootstrap. `pass244_launch.md`.

### H55 — H28 @ lr=5.5e-6 (non-α)
- **Claim:** between H42 5e-6 and dead H52 6e-6 → m>0.04.
- **Status:** train + post_train relaunch (soft-abort recover). `pass243_launch.md`.

### H56 — H42 @ LoRA r=24 (non-α)
- **Claim:** open r gap (r≤8∧r≥32 dead) @ lr=5e-6 → m>0.04.
- **Status:** train + post_train relaunch. `pass243_launch.md`.

### H51 — H28 @ LoRA α=16 @ r16 (non-α)
- **Claim:** α÷2 vs H28 α32 → m>0.04.
- **Status:** n80 b203 ~30/80. `pass242_prefreeze_ok.md`.

### H54 — H28 @ lr=8e-6 (non-α)
- **Claim:** above dead 7.5e-6 → m>0.04 (**low prior** — H50 collapsed).
- **Status:** merge after soft-abort recover. `pass244_post_train_recover.md`.
...
- m=−0.00885 z=−1.02 base×1.246 r=0.630. Gates OK; Λ2_c=−0.011.
  **lr=4e-6 dead.** `s4-h53-…/results/pass244_n80_refute.md`.

### H52 — m7×winner-zA @ lr=6e-6
- m=+0.01280. **lr=6e-6 dead.** `s4-h52-…/results/pass243_n80_refute.md`.

### H50 — m7×winner-zA @ lr=7.5e-6
- m=+0.00322. **lr=7.5e-6 dead.** `s4-h50-…/results/pass243_n80_refute.md`.

### H49 / H45 / H48 / H47 / H46 / H44 / H43 / H42
- α4 / r8 / lr1e-6 band / α8 / lr2.5e-6 / clip≥0.08 / α64 / lr5e-6(+0.016 best).

### H41…H29 / H28 / H27…H1
- See archive + LESSONS. Dead: α-merge / plmk / leary / **TP×ks** /
  **m7×ks** / m7×union / **lr≤2.5e-6∨=4e-6** / **lr=6e-6∨7.5e-6** /
  **lr≥3e-5** / **ep≥2** / **r≤8∨r≥32** / **α≤8** / **α≥64** / **clip≥0.08**.
