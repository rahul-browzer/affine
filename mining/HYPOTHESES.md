...
| # | id | claim | status |
|---|---|---|---|
| 1 | R1 | Teacher-ref SFT / distill on current king init raises Reason margin > 3·SE | **weak** — R1 n80 +0.0005; **R1b train 3/126** + merge→n80 waiter armed |
...
- **Status:** weak / R1b in flight. R1 LoRA@8192 → margin **+0.000516** (z=0.105). R1b: max_len=16384 kept **1006/1403**; train **3/126** @~42s/it (pid79866); waiter pid80760 → merge `/tmp/r1b_lora_merged` → n80 → `r1b_lora_decision.json`. HF `r1lora@569a68be` not for submit.
