...
|---|---|---|---|---|
| 1 | H91 | med | **Tok-init** × winner-zA@r12 → m>0.04 | **open** (n80 ~31/80) |
| 2 | H94 | med | **Tok-init** × winner-zA@r11 → m>0.04 | **open** (n80 ~28/80) |
| 3 | H93 | med | **Tok-init** × winner-zA@r15 → m>0.04 | **open** (n80 ~46/80) |
| 4 | H95 | med | **Tok-init** × winner-zA@r10 → m>0.04 | **open** (post_train) |
| 5 | H96 | med | **Tok-init** × winner-zA@r9 → m>0.04 | **open** (bootstrap) |
| — | H92 | was med | **Tok-init** × winner-zA@r13 vs Tok | **refuted** m=+0.000618 |
| — | H90 | was med | **Tok-init** × winner-zA@r14 vs Tok | **refuted** m=−0.008472 |
| — | H88 | was med | **Tok-init** × winner-zA@r30 vs Tok | **refuted** m=+0.001358 |
| — | H89…H81 | — | Tok-init r22–r31 | **refuted** (see below) |
...
- m=+0.000618 z=0.087 base×0.980 r=0.681 vs Tok. Gates OK. m≈0.
  **Tok-init r=13 dead vs Tok.** `…/result.md`.
...
### H89 / H87 / H86 / H85
- r31 m=−0.007241; r29 m=+0.005075; r28 m=−0.000341; r27 m=−0.008170.
  All gates OK. **Tok-init r27–r31 dead vs Tok.**
...
- See archive + LESSONS. Dead: α-merge / plmk / leary / **TP×ks** / **m7×ks** /
  m7×union / **lr micro-steps** / **ep≥2** / **r≤8∨=13∨=14∨=16–24∨≥32** /
  **α≤8∨=16∨≥64** / **clip≥0.08** / king-self / **Tok-init
  r13∨r14∨r17∨r18∨r22∨r23∨r25–r31**. Open: **H91/H93–H96** (r12/r15/r11/r10/r9).
