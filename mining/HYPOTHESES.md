...
| 2 | H61 | med | H42 cell @ **lr=5.15e-6** → m>0.04 | **open** (n80 b203 ~12/80 bare) |
| 3 | H60 | med | H42 cell @ **lr=5.3e-6** → m>0.04 | **open** (n80 ~60/80) |
| 4 | H64 | med | H42 cell @ **r=18** → m>0.04 | **open** (p264 recover fired) |
| 5 | H62 | med | H42 cell @ **r=20** → m>0.04 | **open** (n80 ~27/80) |
