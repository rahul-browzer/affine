...
|---|---|---|---|---|
| 1 | H25 | high | TP×Radiant28/m7 α0.90 → m>0.04 | **open** (n80 recover; best clipL1) |
| 2 | H26 | med | TP×kkk-af α0.90 → m>0.04 | **open** (bootstrap) |
| 3 | H23 | low | TP×Talucampe α0.90 | **open** (merge) |
| 4 | H24 | low | TP×0ronoCris α0.90 | **open** (false-probe; recover) |
...
- **Status:** king Triton crashes mid-n80; auto-recover + n80 restart. `s4-h25-tp-adambell-m7-a90/`.

### H26 — TalentPigs × bluecolor777/kkk-af α0.90
- **Claim:** mid clipL1 lottery. Bootstrap on mine-h26-1. `s4-h26-tp-kkk-a90/`.

### H23 / H24
- H23 merge→n80. H24 null-margin ConnectError **false probe** (quarantined); chall relaunch.
