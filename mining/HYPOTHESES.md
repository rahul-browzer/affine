...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e/g/h/q/t/l/n/o/p REFUTE**; **R2j/i/k SKIP**; **R2s/R2u WEAK_SKIP**; **R2v** 0.39×; **R2w** board-skip 0.40×; **R2r** n80 ~16/80; **R2ae SKIP_GATED** sth; **R2af** pure awesome-v8 armed; **R2x–ad** eager |
...
- **Status:** open. Weak Tok/kevin×awesome / saysth×awesome / **saysth×kevin** lanes SKIPPED (Δ≪0.01). **R2d** hr **0.22×**. **R2e/g/h/q/t/l/n/o/p REFUTED**. **R2j/i/k SKIPPED**. **R2s/R2u WEAK_SKIP**. **R2v** pure sft3 local hr **0.39×** ≈ board 450. **R2w** pure asdf **SKIP_BOARD_FIRST** (chal-00451 hr **0.40×**). **R2p** Talent×sth **REFUTE** hr **−0.93×**. **R2r** n80 ~16/80. **R2ae** pure-sth **SKIP_GATED** (HF gated=manual; purged p1979). **R2af** pure awesome-v8 armed post-R2r (pid 268343) + Stage-5. **R2x–ad** still wait board Reason+. Disk ~248 GiB. Dir: `experiments/r2-multiking-merge/`.
