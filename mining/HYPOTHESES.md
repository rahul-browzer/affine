...
|---|---|---|---|---|
| 1 | H5c | highest now | kevin-init thought LoRA on **expanded** teacher_refs → clip-L1≥0.042, r∈[0.70,0.85], margin **> 0.04** vs TalentPigs | **open** — train pid **2820** on `mine-h5c-1` GPUs 6,7; 99 steps; DATA=791 shortz thought_ok=791 |
