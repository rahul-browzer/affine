...
|---|---|---|---|---|
| 1 | H81 | med | **Tok-init** × winner-zA@r22 → m>0.04 | **open** (n80 ~44/80) |
| 2 | H82 | med | **Tok-init** × winner-zA@r23 → m>0.04 | **open** (n80 LIVE) |
| 3 | H83 | med | **Tok-init** × winner-zA@r25 → m>0.04 | **open** (merge shard2) |
