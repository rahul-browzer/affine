...
|---|---|---|---|---|
| 1 | H27 | high | winner-zA LoRA → clipL1≥0.042, m>0.04 | **open** (train ~30/51) |
| 2 | H25 | high | TP×Radiant28/m7 α0.90 → m>0.04 | **open** (n80 ~72/80) |
| 3 | H24 | low | TP×0ronoCris α0.90 | **open** (n80 ~33/80) |
| 4 | H26 | med | TP×kkk-af α0.90 → m>0.04 | **open** (n80 @1/80) |
| 5 | H23 | low | TP×Talucampe α0.90 | **open** (t up; k/c load) |
...
- **Status:** TRAIN step~30/51 loss≈0.45 GPUs6,7. `s4-h27-clip-l1-shape/`.

### H25 — TalentPigs × Radiant28 ckpt1000-m7 α0.90
- **Claim:** c_clipL1=+0.0435 → merge m>0.04. n80 ~72/80; form+retry armed.
- **Status:** `s4-h25-tp-adambell-m7-a90/`.

### H24 / H26 / H23
- H24: n80 ~33/80. H26: n80 @1/80 (pass173 armed missing form watcher).
- H23: teacher health=200; king/chall still compiling on B300.
