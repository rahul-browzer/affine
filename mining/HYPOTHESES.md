...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e/g/h REFUTE**; **R2j/i SKIP**; **440 saysth** 0.73×; **R2q n80 ~22/80**; **R2s** saysth×awesome CPU; **R2k…p/R2r** armed |
...
- **Status:** open. Weak Tok/kevin×awesome lanes SKIPPED (Δ≪0.01). **R2d** hr **0.22×**. **R2e** Talent×awesome **REFUTED** (hr −1.18×). **R2f** WEAK_SKIP. **R2h** Tok×Talent×kevin equal-α **REFUTED** (hr −0.59×). **chal-00440 saysth** hr **0.73×** — **R2g** Talent×saysth **REFUTED** (hr −0.89×). **R2j** Talent×BKN7 **SKIPPED** (chal-00432 hr **−0.57×**). **R2i** Talent×thomp **SKIPPED** (chal-00441 **unservable**). **R2q** pure saysth-v9a **n80 RUNNING** (~22/80; pid 171850). **R2s** saysth0.75×awesome0.25 CPU premerge **RUNNING** (n80 after R2q; priority over R2r). **R2k…p** Reason+-gated; wait include yields to R2q/R2s. **R2r** Talent×whoami **ARMED** (after R2q+R2s + 458 hr>0). diane/nvidia/aurora gated. Dir: `experiments/r2-multiking-merge/`.
