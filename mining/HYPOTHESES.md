...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e/g/h/q/t/l/n/o/p/r REFUTE**; **R2ag REFUTE −0.52×**; **R2j/i/k SKIP**; **R2s/R2u WEAK_SKIP**; **R2v** 0.39×; **R2w** board-skip 0.40×; **R2ae SKIP_GATED**; **R2af/R2x SKIP_BOARD** v8; **R2y SKIP_UNSERVABLE**; **R2ah/R2z SKIP_BOARD** v9 hr0.21×; **R2ai RESET**; **R2aj SKIP_BOARD** sky hr0.459×; **R2ak** local **0.641×** / board470 **0.094×**; **R2al** pig n80 ~18/80; **R2ab** wait R2al; **R2ac** premerge DONE; **R2ad** REARMED Talent×pig (p2009; gate 471); **R2aa** stubbed |
