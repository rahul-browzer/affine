...
- **Status:** open. **R2d** 0.22×; many Talent-skew REFUTEs (e/g/h/q/t/l/n/o/p/r/ab/ac/ad/**am −1.39×**). **R2an SKIP_BOARD** cp13. **R2ao REFUTE** pure af17 hr **−0.074×** (n=80). **R2ap WEAK_SKIP** pure h44 hr **0.327×** (m+0.0041, z=0.98, n=80). **R2aq** pure-now ~30/80; **R2ar→as→at→au(sft4)→av(Bittoby-v2)** wait chain armed (v2 prefetch running @766dbdc). Next: mt1 (494). Host-hist pending 485–495. **R2ak** local 0.641×. Dir: `experiments/r2-multiking-merge/`.
