...
|---|---|---|---|---|
| 1 | H122/F27 | high | Genesis full-FT → m>+0.015 | **open** (n80 16/80) |
| 2 | H123/F28 | high | Tok full-FT × teacher_refs → m>+0.015 | **open** (n80 22/80) |
| 3 | H121/F26 | high | Tok full-FT (not LoRA) → m>+0.015 | **open** (n80 14/80) |
...
| 11 | H117/F22 | high | raw everest12 (no LoRA) → m>+0.015 | **open** (chall recover264) |
...
- mine-f33-1 train. `s4-h128-f33-pandora-full-ft/`.
...
- mine-f35-1 train. `s4-h130-f35-everest-full-ft/`.

### H117/F22 — raw everest12 (no LoRA)
- Unmodified everest12 @a5ac5311 vs Tok → m>+0.015.
- mine-f22-1 bare chall shm-cancel; recover264 king-seed launched @06:16Z. `s4-h117-f22-raw-everest12/`.
