...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e/g/h/q/t/l/n/o/p/r REFUTE**; **R2j/i/k SKIP**; **R2s/R2u WEAK_SKIP**; **R2v** 0.39×; **R2w** board-skip 0.40×; **R2ae SKIP_GATED**; **R2af/R2x SKIP_BOARD** v8 hr−0.04×; **R2ag** pure-tpc9 n80 gathering (~9/5); **R2y–ad** wait 463/467–471 |
...
- **Status:** open. Weak Tok/kevin×awesome / saysth×awesome / **saysth×kevin** lanes SKIPPED (Δ≪0.01). **R2d** hr **0.22×**. **R2e/g/h/q/t/l/n/o/p/r REFUTED**. **R2j/i/k SKIPPED**. **R2s/R2u WEAK_SKIP**. **R2v** pure sft3 local hr **0.39×**. **R2w** asdf **SKIP_BOARD** 0.40×. **R2ae** sth **SKIP_GATED**. **R2af** pure awesome-v8 **SKIP_BOARD_FIRST** (chal-00462 hr **−0.04×**, p1986). **R2x** Talent×v8 **SKIP**+purge same board. **R2ag** pure tpc9 local n80 **gathering** (p1988; engines 200/200/200; ~king9/chall5 of 80; block `ef8cf0a9…`). **R2y–ad** wait 463/467–471 Reason+. Disk ~378 GiB. Dir: `experiments/r2-multiking-merge/`.
