...
| # | id | claim | status |
|---|---|---|---|
| 1 | R1 | Teacher-ref SFT / distill on current king init raises Reason margin > 3·SE | **open** — LoRA train running (GPUs 6–7); H64 n80 baseline pending |
...
- **Status:** open. H64 baseline n80 ~30/80; LoRA train pid23282 on Tok init + `sft_high_reason.jsonl` n=1403 (loss_on=thought).
