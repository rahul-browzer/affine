...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e/g/h/q/t/l/n/o REFUTE**; **R2j/i/k SKIP**; **R2s/R2u WEAK_SKIP**; **R2v** 0.39×; **R2w** board-skip 0.40×; **R2p** Talent×sth **n80~47/80** Δ0.671 (board 455 hr **0.79×**) + Stage-5 arm; **R2x/y/z** wait Reason+; watches **468–471 ARMED**; google~46GiB · pig-after-google ARMED |
