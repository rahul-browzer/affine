...
|---|---|---|---|---|
| 1 | H5b | highest now | TalentPigs-init thought-only LoRA (lr=1e-5) → margin **> 0.04** | **open** — n80 **RUNNING** pid **276121** (king39/chall40 @09:02Z; ETA~09:28Z @~1.61tpm); pipe **266631**; harvest **1964910** |
