...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e/g/h/q/t REFUTE**; **R2j/i/k SKIP**; **R2s/R2u WEAK_SKIP**; **440 saysth** 0.73× parent-only; **R2v** sft3 n80 ~32/80 + bridge→R2l + **stage5-push**; **R2w** asdf armed (chall ready) + bridge→R2n; **R2l…p/R2r** armed |
...
- **Status:** open. Weak Tok/kevin×awesome / saysth×awesome / **saysth×kevin** lanes SKIPPED (Δ≪0.01). **R2d** hr **0.22×**. **R2e/g/h/q/t REFUTED**. **R2j/i/k SKIPPED**. **R2s/R2u WEAK_SKIP**. **chal-00440 saysth** hr **0.73×** parent-only. **R2v** pure sft3@381dbc82 **n80 ~32/80** (sim 194935; board 450 still scoring, gzip 404). **bridge_r2v_to_r2l** + **watch_r2v_stage5_push** (pid 198235; HF-only on ≥1.5×). **R2w** pure asdf@c2309815 **ARMED** (pid 197123; `/root/r2_out/asdf_chall` pre-staged w/ preprocessor). **bridge_r2w_to_r2n** armed. **R2l…p** Reason+-gated. **R2r** Talent×whoami armed (after 458 hr>0 + R2v/R2w terminal). diane/nvidia/aurora gated. Dir: `experiments/r2-multiking-merge/`.
