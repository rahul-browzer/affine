...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e REFUTE**; **R2f SKIP**; **R2h TTK REFUTE**; **440 saysth** hr=0.73×; **R2g** Talent×saysth **n80 ~16/80**; **R2i** wait 441; **BKN seven** load_challenger; BKN six+sft3 DONE; **asdf** prefetching; **zeus** after asdf; **sth (455)** after zeus |
...
- **Status:** open. Weak Tok/kevin×awesome lanes SKIPPED (Δ≪0.01). **R2d** hr **0.22×**. **R2e** Talent×awesome **REFUTED** (hr −1.18×). **R2f** WEAK_SKIP. **R2h** Tok×Talent×kevin equal-α **REFUTED** (hr −0.59×). **chal-00440 saysth** hr **0.73×** — **R2g** Talent0.25×saysth0.75 (Δ=0.626) **n80 ~16/80** pid146391. **R2i** gated on 441 Reason+. **chal-00432** BKN seven `load_challenger`; BKN six+sft3 DONE; **asdf** (451) downloading; **zeus** (452) after asdf; **sth** (455 `fortunateGambler/…-sth@8d81e782…`) armed after zeus (p1919, weights_ok). Dir: `experiments/r2-multiking-merge/`.
