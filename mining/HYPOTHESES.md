...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e REFUTE**; **R2f SKIP**; **R2h TTK REFUTE**; **440 saysth** hr=0.73×; **R2g** ~52/80; **R2i** wait 441; **R2j** wait 432; **R2k** Talent×BKN6 armed (431 Reason+); **cp200** ~11/12 |
...
- **Status:** open. Weak Tok/kevin×awesome lanes SKIPPED (Δ≪0.01). **R2d** hr **0.22×**. **R2e** Talent×awesome **REFUTED** (hr −1.18×). **R2f** WEAK_SKIP. **R2h** Tok×Talent×kevin equal-α **REFUTED** (hr −0.59×). **chal-00440 saysth** hr **0.73×** — **R2g** Talent0.25×saysth0.75 **n80 ~52/80** pid146391. **R2i** gated on 441 Reason+. **R2j** Talent0.25×BKN7 0.75 wait 432. **R2k** Talent0.25×BKN6 0.75 armed (p1922; wait 431 Reason+ then R2g/R2i/R2j lane). Prefetch: BKN six+sft3+asdf+zeus+sth DONE; **cp200** ~11/12. nvidia 00436 still weight-gated. Dir: `experiments/r2-multiking-merge/`.
