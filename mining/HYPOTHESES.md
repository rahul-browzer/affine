...
| 2 | R2 | Merge / continue-train recent kings for teacher-helpful z | **open** — **R2d** 0.22×; **R2e/g/h/q/t/l/n/o/p/r/am REFUTE**; **R2ag/ab/ac/ad REFUTE**; **R2j/i/k SKIP**; **R2s/R2u WEAK_SKIP**; **R2v** 0.39×; **R2w** board-skip 0.40×; **R2ae SKIP_GATED**; **R2af/R2x/R2ah/R2z/R2ai/R2aj/R2al SKIP_BOARD**; **R2y SKIP_UNSERVABLE**; **R2ak** local **0.641×**; **R2am REFUTE −1.39×**; **R2an SKIP_BOARD** cp13; **R2ao** pure af17 reload/TKC rescue; **R2ap/R2aq** armed; **R2aa** stubbed |
...
- **Status:** open. **R2d** 0.22×; many Talent-skew REFUTEs (e/g/h/q/t/l/n/o/p/r/ab/ac/ad/**am −1.39×**). **R2an SKIP_BOARD** cp13. **R2ao** pure af17 reloading after p2032 TKC rescue; **R2ap/R2aq** wait (orphan-kill patched). Prefetch h44/now/af17 DONE; watch 485/486/489. **R2ak** local 0.641×. Dir: `experiments/r2-multiking-merge/`.
