...
- **Status:** engines ALL_READY 13:08Z; n80 attempt1 ~1/80. Detail: `experiments/s4-h12-tp-dfwas-merge/`.
...
- **Status:** n80 ~31/80; `watch_n80_retry` armed. Detail: `experiments/s4-h11-tp-adambell-merge/`.
...
- **Status:** n80 retry 1/3 ~19/80. Detail: `experiments/s4-h9-tp-diane-merge/`.
...
- **Status:** n80 ~42/80; `watch_n80_retry` armed. Detail: `experiments/s4-h10-tp-kevin-merge/`.
