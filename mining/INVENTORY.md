...
|---|---|---|---|---|---|---|---|---|
| mine-sim-1 | swift-shark-52 | 523f52ca-35f2-4ac4-ac74-97ac44a41d81 | 8×H200 | 23.60 | **Lium TTL cancelled**; host deadman **07:00Z**; harvest H1v2+push-gated | Stage 4 H1 n80 + H1v2 train+pipe(merge∥n80)+HF; harvest **1644437** | RUNNING | SSH `root@69.63.236.160 -p 40301`; n40 DONE revise_recipe; n80 **149213** ~37/37; H1v2 **147209** step23/55 loss0.448; pipe **164147** (merge before n80 wait); mid-salvage **154590**; engines 200×3; freed h2-kp65 68G; harvest **1644437**; deadman 1405846; chal-00280 scoring; spent $144.05 |
