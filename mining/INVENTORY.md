...
|---|---|---|---|---|---|---|---|---|
| mine-sim-1 | swift-shark-52 | 523f52ca-35f2-4ac4-ac74-97ac44a41d81 | 8×H200 | 23.60 | **Lium TTL cancelled**; host deadman **07:00Z**; harvest H1v2 n80-aware | Stage 4 H1v2 n80 SIM + HF merged retry | RUNNING | SSH `root@69.63.236.160 -p 40301`; n80 **198714** (~10/80@05:47); pipe **171602**; HF merged push **202393** public (quota fix); harvest **1670883**; deadman 1405846; chal-00283 scoring; spent $162.94 |
