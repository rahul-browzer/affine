...
|---|---|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd (`3d07e519-…`) | 8×B200 | $52.25 | **2026-08-13T02:35Z** | **R22** golden-GRPO ~101/200 |
| mine-r3-grpo-1 | golden-hawk-ff (`d55eec0f-…`) | 8×B300 | $64.00 | **2026-08-13T04:29Z** | **R23** diane-GRPO ~11/200 |
| mine-r4-fullft-1 | noble-orbit-9d (`70f95aab-…`) | 8×B300 | $64.00 | **2026-08-13T08:57Z** | **R27** BigG G=16 ~2/200 |
...
Non-mine (do not touch): `affine-eval`, `affine-bench`, `affine-datagen`, `affine-teacher`.

## Last reconciles

| when | action |
|---|---|
| 2026-08-12T13:30Z | p2254: 8×=0; HF purge −281 GiB; trains R22/23/27 OK; burn **$180.25/h** |
