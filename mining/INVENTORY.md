...
|---|---|---|---|---|---|---|---|---|
| mine-sim-1 | swift-shark-52 | 523f52ca-35f2-4ac4-ac74-97ac44a41d81 | 8×H200 | 23.60 | **Lium TTL cancelled**; host deadman **12:00Z**; H5b harvest **1917667** →11:45Z | Stage 4 H5b train step31/55; n80≤3 + abort trap + harvest | RUNNING | SSH `root@69.63.236.160 -p 40301`; train **245350** pipe **256662** mid **251832**; deadman **1783662**; spent ~$216 |
