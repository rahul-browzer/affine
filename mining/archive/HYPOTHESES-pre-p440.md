...
| 2 | H113/F18 | high | raw TalentPigs (no LoRA) → m>+0.015 | **open** (bootstrap p440) |
| 3 | H105/F10 | high | TalentPigs × high-Λ2 → m>+0.015 | **open** (n80 ~13/80) |
| 4 | H106/F11 | high | pandora × high-Λ2 → m>+0.015 | **open** (n80 ~18/80) |
| 5 | H108/F13 | high | diane613 × high-Λ2 → m>+0.015 | **open** (n80 ~32/80) |
| 6 | H109/F14 | high | Bittob11040 × high-Λ2 → m>+0.015 | **open** (n80 ~16/80) |
| 7 | H110/F15 | high | everest12 × high-Λ2 → m>+0.015 | **open** (n80 ~17/80) |
| 8 | H111/F16 | high | af-k1 × high-Λ2 → m>+0.015 | **open** (train) |
...
- **Status:** n80 ~13/80 vs Tok. `experiments/s4-h105-f10-talentpigs-base/`.

### H106 / F11 — pandora-box × high-Λ2 — open
- **Claim:** pandora @5218b138 + 1059 high-Λ2 → m>+0.015.
- **Status:** n80 ~18/80 d203. `s4-h106-f11-pandora-base/`.

### H108 / F13 — diane613 × high-Λ2 — open
- **Claim:** diane613 @ad0f3f11 + 1059 high-Λ2 → m>+0.015.
- **Status:** n80 ~32/80. `experiments/s4-h108-f13-diane613/`.

### H109 / F14 — Bittob11040 × high-Λ2 — open
- **Claim:** Bittob11040 @0c04fe92 + 1059 high-Λ2 → m>+0.015.
- **Status:** n80 ~16/80. `experiments/s4-h109-f14-bittob/`.

### H110 / F15 — everest12 × high-Λ2 — open
- **Claim:** everest12 @a5ac5311 + 1059 high-Λ2 → m>+0.015 vs Tok.
- **Status:** n80 ~17/80. `s4-h110-f15-everest12/`.

### H111 / F16 — af-k1 × high-Λ2 — open
- **Claim:** af-k1 @ff6eb4bc + 1059 high-Λ2 → m>+0.015 vs Tok.
- **Status:** train. `experiments/s4-h111-f16-af-k1/`.

### H112 / F17 — raw genesis (no LoRA) — open
- **Claim:** unmodified genesis @abe89194 vs Tok → m>+0.015 (honest panel +0.16).
- **Status:** bootstrap (DL chall). `experiments/s4-h112-f17-raw-genesis/`.

### H113 / F18 — raw TalentPigs (no LoRA) — open
- **Claim:** unmodified TalentPigs @dbfbb3e2 vs Tok → m>+0.015 (≠ F10 LoRA).
- **Status:** bootstrap (p440 rent). `experiments/s4-h113-f18-raw-talentpigs/`.
...
| F18 | raw TalentPigs no-LoRA | **screening** (mine-f18-1) |
| — | next raw-base | kevin954 / pandora / diane unmodified |
...
- Dead: α/plmk/TP/m7/union/lr/ep≥2/**winner-zA (−0.004)**/F1–F4/F6–F9/F12.
  Screens live: **F10–F11/F13–F18**. Archive + LESSONS.
