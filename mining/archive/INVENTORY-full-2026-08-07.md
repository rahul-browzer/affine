...
|---|---|---|---|---|---|---|---|---|
| mine-h5c-1 | golden-hawk-dc | b14c030f-4588-4090-a704-61e1e212c86a | 8×H200 | $28.00 | remove 2026-08-07T19:37:46Z (10h) | H5c train + prewarm teacher/king + post-train→n80 | RUNNING | SSH 152.236.142.234:40298; train **2820** GPUs 6,7 step17/99; pipe **10642** waiting train.done; teacher+king :8000/:8001 READY; mid **5194**; HF write-probe OK `…-h5c-lora`@`38af0ca…`; corpus 9000; host harvest **2090851** / deadman **2090852**@19:00Z; known_hosts `/tmp/mine-h5c-1.known_hosts` |
...
|---|---|---|
| 2026-08-07T10:01:07Z | mine-h5c-1 RUNNING | matches inventory; spent $10.88; train **2820** step17/99; pipe **10642** wait; mid **5194**; t/k READY; pass108 HF write-probe + merge-path preflight OK; harvest **2090851** / deadman **2090852**; validator pods untouched |
| 2026-08-07T09:58:27Z | mine-h5c-1 RUNNING | matches inventory; spent $9.64; train **2820** step14/99; pipe **10642** wait; t/k READY; pre-created missing H5c HF repos (pod write OK); harvest **2090851** / deadman **2090852**; validator pods untouched |
