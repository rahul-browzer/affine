...
| Lium / spend | **~$186,814** · cum ~$9,464 · **avail ~$176.8k** |
| miner | τ10.000 free · 0 submissions |
| H76 | **n80 LIVE** a203 ~35/80 + mid304 |
| H77 | **king308 LOADING** → retry 0/120 + mid304 |
| H78 | **n80 LIVE** a203 ~43/80 + mid304 |
| H79 | recover264 chall loading (Tok-proc OK) → n80 |
| H80 | king loading → merged-chall → n80 |
...
**p308:** H77 pass306 hung (Triton ImportError→shm hang); killed +
`king_recover_pass308.sh` (pid29360; king29588). `…/pass308_king_recover.md`.
...
1. H77: await king308 PROMPTABLE → fresh a203 n80.
2. H79: await recover264 triple-promptable → n80 a203 (+ rearm preempt if TIMEOUT).
3. H80: await king+merged-chall promptable → n80 vs Tok.
