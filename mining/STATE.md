...
| B300 stock | **0** free 8×B300/B200 (burst p2205 next=R25) |
| Lium bal | ~$117,900 · floor $10k OK |
| submissions | 0 |
| R15 | **REFUTED** n80 m=**−0.0268** z=−2.25 hr=−1.12× (p2205) |
| R17 | **training** coder-REINFORCE crown ~step **150**/200 |
| R20 | **training** kevin-GRPO mine-r4 ~step **128**/200 |
| R24 | **training** Tok LongCtx-GRPO mine-r3 pid**88309** max_len=16384 |
...
R24: `tail -f /root/logs/r3_train.nohup` · launched `/root/affine_data/r24_train_launched.json`
...
**R24/R17/R20:** continue train → merge→n80 when DONE (MERGED=/tmp + contig+5GB).
**R15 closed** — do not resubmit / re-arm pandora-REINFORCE.
