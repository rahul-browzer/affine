...
**H67 scaffolded** (r=19) — rent on first free slot.
...
| Lium / spend | **~$187,873** · cum mining ~$7,743 · **avail ~$177.9k** |
| miner | τ10.000 free · 0 submissions |
| H61 | n80 **b203** @ **~3**/80 (a203 teacher-400→retry; freeze 555/n_so=23) |
| H63 | n80 a203 @ **~36**/80 |
| H64 | n80 a203 @ **~32**/80 |
| H65 | merge_lora save in progress → preempt264→n80 |
| H66 | pip install finishing → train |
...
|---|---|---|---|---|
| mine-h61-1 | golden-matrix-4b | 38.255.28.18:20100 | ~18:47Z | n80 b203 ~3/80 |
| mine-h63-1 | noble-eagle-3f | 38.255.28.19:20100 | ~19:28Z | n80 ~36/80 |
| mine-h64-1 | gentle-wolf-eb | 38.255.28.21:20099 | ~19:28Z | n80 ~32/80 |
...
2. On free slot → **rent H67 r=19** (`upload_and_launch.sh`); patch SOFT/DEADMAN
   to TTL−1h; UUID≥$28/h; COUNT=8; confirm preempt264 pid.
3. Else fill lr≈4.95/5.04 neighbour (scaffold next).
