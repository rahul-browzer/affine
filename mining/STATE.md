...
| Lium balance | ~$123,713 · floor ≥$10k · burn **$64/h** (≤$833/h ok) |
...
| R2h Tok×Talent×kevin | **n80 RUNNING** · sim **137312** · ~7/80 · bh `bdd5bd38…` |
...
|---|---|---|---|---|
| mine-crown-1 | lunar-orbit-50 | `ssh root@86.38.182.50 -p 40300` | 2026-08-11T16:12Z | TK@65536 + R2h n80 + 440/R2g wait + thomp prefetch |
...
- Do **not** merge thompsville until its duel shows Reason+ (prefetch only).

## Next action

**Harvest R2h** when `/root/affine_data/r2h_ttk_decision.json` exists. If headroom ≥ 1.5× → Stage-5. Else R2g if saysth Reason+; else gate Talent×thompsville on chal-00441 Reason+ (weights cached) or rescan new completed evals.
