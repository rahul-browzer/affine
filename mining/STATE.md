...
| B300 stock | **0** free 8×B300/B200 (p2194 1500-iter burst running) |
| Lium bal | ~$118,317 · floor $10k OK |
| submissions | 0 |
| R14 | **REFUTE** n80 m=**−0.0215** z=−1.14 (p2194) |
| R15 | **training** pandora-REINFORCE on mine-r3 ~step **75**/200 |
| R16 | train DONE → **merge** golden (BASE fixed) on mine-crown |
| R20 | **training** kevin-GRPO on mine-r4 ~step **2**/200 |

## What's running

| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R16** merge→n80 (TKC warm) |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **R15** pandora-REINFORCE |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R20** kevin-GRPO (after R14) |
...
R20: `tail -f /root/logs/r3_train.nohup` · post `/root/logs/r20_post_train.nohup`
Fleet: `tail -f experiments/fleet-rent/logs/burst_p2194.log`
...
**R16:** merge→chall→n80 vs ckp333 (hr≥1.5×) → Stage-5 if ADVANCE.
**R15/R20:** wait train→merge→n80. **Fleet next:** R25… then R5b/R10/R17… (R15/R16/R20 live).
