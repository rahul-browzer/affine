...
| Lium / spend | **~$187,001** · cum ~$9,190 · **avail ~$177.0k** |
| miner | τ10.000 free · 0 submissions |
| H74 | **REFUTE** m=−0.011003 vs Tok (torn) |
| H75 | n80 vs Tok a203 **~69/80** |
| H76 | n80 vs Tok a203 **~18/80** |
| H77 | **recover264** chall loading (Triton ENOENT → relaunch) |
| H78 | merge.done; chall loading :8002 |
| H79 | **bootstrap** Tok-init×winner-zA@r18 (new init axis) |

## What's running

| name | huid | SSH | TTL | role |
|---|---|---|---|---|
| mine-h75-1 | cosmic-hawk-20 | 38.255.28.21:20100 | ~23:07Z | **n80 vs Tok** ~69/80 |
| mine-h76-1 | gentle-raven-df | 38.255.28.18:20100 | ~23:38Z | **n80 vs Tok** ~18/80 |
| mine-h77-1 | eager-shark-64 | 152.236.142.237:40306 | ~23:44Z | **recover264** → n80 |
| mine-h78-1 | eager-comet-a4 | 38.255.28.22:20100 | ~23:44Z | **chall load** → n80 |
| mine-h79-1 | lunar-shark-be | 152.236.142.232:40100 | ~00:18Z+1d | **bootstrap** Tok-init |
...
1. H75/H76: await n80 `decision.json` vs Tok → tear / shortlist / submit-gate.
2. H77: await recover264 warm+freeze → n80; if FAIL×3 → quarantine note, not REFUTE.
3. H78: await chall promptable → n80 vs Tok (same Triton risk as H77).
4. H79: await bootstrap→train→merge→n80 vs Tok.
5. Free slot → non-α neighbor; **no more m7×r18**; prefer init/data or r≠18.
