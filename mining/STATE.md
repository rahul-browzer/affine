...
| R25 | **guass :8001 DONE**; train active |
| R17 | **REFUTE** vs guass m=−0.014 (p2210) |
| R20 | **REFUTE** vs guass m=**−0.0196** z=−2.13 (p2211) |
| R21 | **training** ~step **71**/200 (pandora-GRPO) |
| R24 | **training** ~step **80**/200; post+form wait train.done; guass KING |
| R26 | **training** LoTemp on crown |
...
**R24:** train→merge→n80 vs guass (~step 80; form waiting clean sim).
