...
| R29/R30 arm | guass + Reason writer + form-dec (p2231) |
| R31/R32 arm | **p2232** Tok-init + guass n80 + Reason writer + form-dec |
| R26 | train~**176**/200; guass :8001 |
| R24 | train~**135**/200 |
| R21 | train~**179**/200 |
| R25 | train~**115**/200 |
...
R31 arm: `experiments/r31-nodrop-grpo/artifacts/p2232_guass_king_arm.json`
R32 arm: `experiments/r32-kl-grpo/artifacts/p2232_guass_king_arm.json`
...
## Next action
1. Keep burst snatching; R5b→R19→R22→R23→R27→R28→R29→R30→R31→R32 all guass+writer armed.
2. R24/R21/R25/R26 train→merge→n80 vs **guass**; any clear → Stage-5.
3. If still empty stock: arm next distinct axis (R33+) or prewarm more parent bases.
