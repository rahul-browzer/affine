...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2ba WEAK** m=+0.007 z=1.40 · idle chall |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | GRPO pid28660 step≥**93** + wedge |
| host fleet-rent | pid**2406489** | — | →25 mines @10s (R4…R28) |
| host fleet-boot | pid**2406492** | — | auto-upload R4–R28 |
...
## Next action
**Crown:** arm **R2bb** next unscreened board parent (ckp333/ec08/ckp55 via host-hist).
**R3:** train.done→n80.
**Else:** fleet-boot on B300×8 (R28 HiLR after R27).
**Else:** next structural axis >R28 (e.g. HiRank r=64 alone).
