...
| Lium / spend | **~$184,143** · cum ~$13,180 · **avail ~$174.1k** |
| miner | τ10.000 free · 0 submissions |
| burn | **~$213/h** (6 mine-*) ≪ $833/h · free slots **14** |
| F1 | merge DONE; chall loading bare TCACHE; **preempt rearmed p381** |
| F4 | CPU merge shard2 tmp~19 GiB wchar↑ |
| F6 | CPU merge tmp~47 GiB wchar↑; T/K live |
| F7 | merge DONE; push; **king recover** :8001 loading; preempt live |
| F8 | RL train live; teacher :8000=200 |
| F9 | kevin954 DL ~22 GiB (10/12) |

## What's running

| name | huid | SSH | TTL | role |
|---|---|---|---|---|
| mine-f1-1 | brave-hawk-5a | 86.38.238.54:40099 | ~07:05Z+1d | F1 chall→recover→n80 |
...
| mine-f7-1 | lunar-shark-87 | 152.236.142.232:40311 | ~08:52Z+1d | F7 king recover+push |
...
**F7:** await king_recover DONE (:8001 promptable) before n80.
**F1:** bare chall TCACHE — preempt must fire recover264 at :8002=200.
...
1. **F1** await :8002=200 → preempt→recover264 → n80 vs Tok.
2. **F7** await king recover DONE + chall serve → n80.
