...
| B300 stock | **0** free 8×B300/B200 (p2184 200-iter burst + waiter) |
| Lium bal | ~$118,922 · floor $10k OK |
| submissions | 0 |
...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bn** n80 ~45/80; **R9** LoRA ~346/354; post R2bn-gated |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **R3b** GRPO ~step159/200 |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R12** BoN-CE ~step85/150 |
...
**p2184:** `SKIP_PID_LOCK` 200-iter burst empty; waiter CONT@iter1961. Crown Removal **2026-08-13T02:35:59Z**.
...
Fleet: `tail -f experiments/fleet-rent/logs/wait_fleet_b300.log` · burst `…/burst_p2184.log`
