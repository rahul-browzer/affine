...
**Stage 4 — H6/H9–H12 n80 live; H13+H14 staged.** 0–3 done.
...
| Lium / spend | $33,225 · ~$610 · cap rem ~$3,390 |
| miner | τ10.000 free · 0 submissions |
| H6 | n80 ~11/80; retry watcher armed |
| H9 | n80 retry 1/3 ~19/80 |
| H10 | n80 ~42/80; retry watcher armed |
| H11 | n80 ~31/80; retry watcher armed |
| H12 | n80 attempt1 started 13:08Z (~1/80); engines ALL_READY |
| H13 | **staged** TP×`bluecolor777/kkk-af`@7426296b (priority) |
| H14 | **staged** TP×`vincentwarrior/…-kkkk`@3ca1ebe6 (2nd slot) |
...
H6/H10/H11: `watch_n80_retry.sh`. H9/H12: inline 3× retry.

## Blocked

No submit until some n80 margin > 0.04. No pandora / golden-crown merges (band).
H13/H14: wait free slots; scripts ready under `experiments/s4-h13-tp-kkk-merge/`
and `experiments/s4-h14-tp-kkkk-merge/`.

## Next action

**Poll for first nested `*_decision.json` (H10 closest ~42/80, then H11/H9/H6/H12).**
