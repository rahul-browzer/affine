...
| Lium | ~$123,613 · burn **$64/h** (≤$833/h) · floor ≥$10k |
...
| 440 saysth | hr **0.73×** · **R2g** n80 **~36/80** pid **146391** |
| R2i | Talent×thomp gated on 441 Reason+ (armed) |
| **R2j** | Talent×BKN7 **ARMED** · wait 432 Reason+ · pids **150140/150142** |
| prefetch | BKN6+sft3+asdf+zeus **DONE** · **sth** ~8 GiB pid **149631** |

## What's running

| name | SSH | role |
|---|---|---|
| mine-crown-1 | `ssh root@86.38.182.50 -p 40300` | TK@65536 · R2g · R2i/441 · R2j/432 · sth |

- Chall=`/tmp/r2g_alpha_merged`. Harvest → `r2g_alpha_decision.json`.
- R2j logs: `/root/logs/r2j_premerge.log`, `r2j_merge_reload.log`.
- sth: `tail /root/logs/r2_prefetch_sth.log` → `r2_prefetch_sth.done`.
...
**Harvest R2g** (`r2g_alpha_decision.json`); submit only if hr ≥ **1.5×**. Else let **R2i**/ **R2j** fire on 441/432 Reason+; confirm sth DONE.
