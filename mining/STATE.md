...
| Lium / spend | **~$189,069** · cum mining ~$5,530 · **avail ~$179.1k** |
| miner | τ10.000 free · 0 submissions |
| H45 | **n80 b203** ~48/80 |
| H49 | **n80 a203** ~1/80 (p231 recover DONE) |
| H50 | bootstrap→train lr=7.5e-6 (just launched) |
| H51 | bootstrap→train α=16 (just launched) |
| H52 | bootstrap→train lr=6e-6 (just launched) |
...
| mine-h50-1 | eager-hawk-5b | 152.236.142.237:40499 | ~15:03Z | H50 lr7.5e-6 train |
| mine-h51-1 | brave-lion-47 | 152.236.142.232:40300 | ~15:03Z | H51 α16 train |
| mine-h52-1 | noble-wolf-4b | 38.255.28.18:20099 | ~15:05Z | H52 lr6e-6 train |
...
1. Poll H45/H49 → `hN_decision.json` (H45 ~48/80; H49 early).
2. REFUTE → `lium rm mine-hN-1` only; fill non-α H28-neighbour (not lr≤2.5e-6).
3. H50–H52: confirm train launched (`TRAIN_LAUNCHED` / trainer_state.json).
