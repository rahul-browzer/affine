...
| B300 stock | **0** free 8×B300/B200 (waiter CONT @iter~681) |
| Lium bal | ~$118,211 · floor $10k OK |
| submissions | 0 |
| R16 | **REFUTE** n80 m=**−0.00935** z=−1.30 hr=−0.65× (p2196) |
| R17 | **training** coder-REINFORCE crown pid**337498** (p2197 empty-z fixed; z0 ok) |
| R15 | **training** pandora-REINFORCE mine-r3 ~step **135**/200 |
| R20 | **training** kevin-GRPO mine-r4 ~step **62**/200 |
