...
| B300 stock | **0** free 8×B300/B200 (API; snatcher empty) |
| Lium bal | ~$119,381 · floor $10k OK |
| submissions | 0 |
...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bl** Bittoby n80 ~19–20/80; **R9** LoRA ~177/354 |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **R3b** GRPO ~step97/200; post→ckp333 |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R11** online-DPO train pid**90891** (post **90897**); T/K up |
...
**p2162:** R7 CLOSE m=+0.0123 z=1.978 <2σ → REFUTE; R10 sbs-v2 gated 403 → warm-armed **R11** on mine-r4.
...
**R11:** wait train.done → merge → n80 vs ckp333 (`h139`/`r11` decision).
