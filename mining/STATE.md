...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bj** n80 ~65/80 + **R9** LoRA ~83/354; king→ckp333 wait R2bj |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **R3b** GRPO ~step73; post_train→**ckp333** + prefetch |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R8** REINFORCE ~step76; post_train→**ckp333** + prefetch |
...
R3b: `tail -f /root/logs/r3_train.nohup` · pipe `r3_post_train.nohup` (KING=ckp333 RESTART_KING=1)
R8: `tail -f /root/logs/r8_train.nohup` · pipe `r8_post_train.nohup` (KING=ckp333 RESTART_KING=1)
Prefetch R3/R8: `tail -f /root/logs/r2_prefetch_ckp333.log`
Fleet: `tail -f experiments/fleet-rent/logs/wait_fleet_b300.log`
**p2153:** R3+R8 post_train retarget→ckp333 + prefetch; B300×8=0; burn **$180.25/h**.
...
**R8/R3b:** wait train.done → merge → RESTART_KING ckp333 → n80 (pipes patched).
