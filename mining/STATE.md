...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bb** ckp333 chall loading (200/200/000) |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | GRPO pid28660 step≥**103** + wedge |
...
**R3:** train.done→n80 (step≥100/200; now ≥103).
