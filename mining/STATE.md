...
| Lium / spend | **~$185,597** · cum ~$11,120 · **avail ~$175.6k** |
| miner | τ10.000 free · 0 submissions |
| H88 | n80 a203 ~66/80 · mid304 · t/k/c=200 |
| H89 | n80 a203 ~71/80 · mid304 · t/k/c=200 |
| H90 | king340 loading · retry rearmed 120 · chall=200 |
| H91 | **king340 DONE** · merge shard2 (~19G tmp) · chall=000 · preempt armed |
| H92 | bootstrap DL tok-init · COUNT=8 @$28 |
...
| mine-h90-1 | noble-shark-3c | 152.236.142.232:40310 | ~04:23Z+1d | king340+retry120 |
| mine-h91-1 | brave-shark-d2 | 38.255.28.18:20099 | ~04:31Z+1d | merge→chall |
...
H90: await `h90_king_recover_pass340.done` then n80+mid304.
H91: merge→chall→preempt; arm mid304 when n80 starts.

## Next action

1. **H90** await `h90_king_recover_pass340.done` + `:8001=200` → n80 a203 + mid304.
2. **H91** await merge.done → chall serve → preempt settle; arm mid304 at n80.
3. **H88/H89** await n80 → `h*_decision.json` (keep mid304).
4. **H92** await `h92_train_launched.stamp`.
