...
| **chal-00458** | whoami Reason+ hr **0.39×** (lost) · R2r parent |
| **R2r** | n80 **gathering** ~6–8/80 · pid **266016** · TKC 200/200/200 |
| live board | phase duel **chal-00462** awesome-v8 (watcher hist fast-path) |
...
| name | SSH | role |
|---|---|---|
| mine-crown-1 | `ssh root@86.38.182.50 -p 40300` | TK@65536 · R2r n80 · R2x–ad wait Reason+ |

- R2r: `tail -f /root/logs/r2r_merge_reload.log` · progress `/root/affine_data/r2r_alpha_reason_progress.json` · decision `/root/affine_data/r2r_alpha_decision.json`
