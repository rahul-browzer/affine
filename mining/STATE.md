...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bb** n80 pid**199154** (~7/80) |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | GRPO pid28660 step≥**110** + wedge |
| host fleet-rent | pid**2436070** | — | →25 mines @10s (R4…R31) |
| host fleet-boot | pid**2436073** | — | auto-upload R4–R31 |
...
## Blocked
No free 8×B300/B200 — rent polls 10s (target **25** / cap 25). **R31** NoDrop armed.

## Next action
**Crown:** R2bb n80 → decision; if WEAK/REFUTE arm **R2bc** ec08 (chal-00502) then ckp55.
**R3:** train.done→n80 (step≥100/200; now ≥110).
**Else:** fleet-boot on B300×8 (R4 first; R31 NoDrop queued after R30).
**Else:** next structural axis >R31 (e.g. EMA-β / KL-coef).
