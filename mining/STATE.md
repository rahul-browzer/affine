...
| Lium | ~$122,841 · burn **$64/h** (≤$833/h) · floor ≥$10k |
| fleet | `mine-crown-1` lunar-orbit-50 8×B300 · TTL→2026-08-11T16:12Z |
| submissions | 0 · hotkey `default` unused |
| live eval | queue …→sbs→sky→google→pig · phase duel chal-00458 |
| disk | `/root` **~115 GiB** free · R2ad pig blend writing |
...
| **R2ad** | Talent×pig eager **RUNNING** · wait 471 Reason+ |
...
| name | SSH | role |
|---|---|---|
| mine-crown-1 | `ssh root@86.38.182.50 -p 40300` | TK@65536 · chall **idle** · R2aa–ac wait · R2ad eager · watches 462/463/467–471 |

- R2ad: `tail /root/logs/r2ad_premerge.log` · eager → `/root/logs/r2ad_eager_weights.done`
- R2ad reload: `tail /root/logs/r2ad_merge_reload.log` (waits premerge.done + priors)
...
**Confirm R2ad eager stamp**; keep R2aa–ad waiters on 468–471 Reason+. On first Reason+ → `premerge.done` → chall reload → n80. Harvest Reason+ 462/463/467–471 when gzips land.
