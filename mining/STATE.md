...
| Lium | ~$122,730 · burn **$64/h** (≤$833/h) · floor ≥$10k |
| fleet | `mine-crown-1` lunar-orbit-50 8×B300 · TTL→2026-08-11T16:12Z |
| submissions | 0 · hotkey `default` unused |
| **R2r** | n80 **~37/80** · pid **266016** · TKC 200/200/200 |
| **R2ae** | **SKIP_GATED** — `fortunateGambler/…-sth` HF `gated=manual` |
| **R2af** | wait R2r · pid **268343** · chall dir **pre-ready** `/root/r2_out/awesome_v8_chall` |
| **HF Stage-5** | pre-purged **+210.7 GiB** (p1983) · watchers armed |
...
**Harvest `r2r_alpha_decision.json`.** If hr≥1.5× → confirm Stage-5 HF push then register+`--check`+submit. Else R2af claims chall→pure awesome-v8 (dir already materialised) n80; harvest `r2af_awesome_v8_decision.json` (hr≥1.5× → Stage-5). On R2af miss, first board Reason+ among 462/463/467–471 → R2x–ad.
