...
| Lium / spend | **~$183,932** · cum ~$13,385 · **avail ~$173.9k** |
| miner | τ10.000 free · 0 submissions |
| burn | **~$213/h** (6 mine-*) ≪ $833/h · free slots **14** |
| F1 | n80 vs Tok **~23/80** (engines 200) |
| F4 | Tok shard2 done; shard1 Range ~12 GiB/35 GiB; king dead awaiting tok.done |
| F6 | n80 a203 live (early; no progress yet) |
| F7 | **b203 n80 live** PID28788; engines 200; TCACHE 755 |
| F8 | RL train live (max_steps 200); teacher/tok.done |
| F9 | kevin LoRA train live (3 PIDs — verify); teacher.done |
...
| mine-f6-1 | noble-shark-14 | 152.236.142.237:40300 | ~08:42Z+1d | F6 n80 vs Tok |
...
**F7:** FALSE_PROBE+watcher restart resets attempt→a203 (H32); force b203.
**F9:** 3× train_lora PIDs on same out-dir — next pass verify not corrupting.
...
1. **F7** await b203 n80 margin vs Tok (PID28788).
2. **F1/F6** await n80 margins.
3. **F4** await Tok Range both shards → tok.done → king+chall → n80.
4. **F9** verify single train_lora; **F8** train→merge→n80.
