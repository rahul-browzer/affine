...
| Lium / spend | **~$186,931** · cum ~$9,340 · **avail ~$176.9k** |
| miner | τ10.000 free · 0 submissions |
| H75 | **REFUTE** m=+0.000550 z=0.101 vs Tok (torn) |
| H76 | king302 loading (:8001=000) → n80 |
| H77 | king302 loading (:8001=000) → n80 |
| H78 | **n80 LIVE** a203 vs Tok (recover264 salvage n_so 16→22) |
| H79 | train_lora Tok-init@r18 (pid live) |
| H80 | train_lora Tok-init@r17 (+ bootstrap teacher/king DL) |
...
| mine-h78-1 | eager-comet-a4 | 38.255.28.22:20100 | ~23:44Z | **n80 a203** pid21809 |
...
**p303:** recover264 DONE → rearm form+n80 but **not** preempt — rearm preempt after DONE.

## Next action

1. H78: await n80 → `decision.json` (sim pid21809 a203). FAIL×3 → quarantine, not REFUTE.
2. H76: await king302 PROMPTABLE → retry n80 a203 → `decision.json`.
3. H77: await king302 PROMPTABLE → retry n80 a203 → `decision.json`.
4. H79: await train→merge→n80 vs Tok.
5. H80: await train→merge→n80 vs Tok.
