...
| R24 | train~**161**/200; post_train waiter live |
| R25 | train~**149**/200; post_train waiter live |
| R33 | guass-init GRPO **step~13**/200 on crown + T/K warm |
| R5b | full-FT **step~6**/26 Talent; Soft/Dead **fixed** p2237 |
...
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R5b** Talent full-FT + post_train |
...
R5b train: `tail -f /root/logs/h122_train.nohup` · R33: `tail -f /root/logs/r3_train.nohup`
...
## Next action
1. R5b train→finalize→n80 vs guass (Soft **07:57Z** / Dead **08:27Z** / Removal **08:57Z**).
