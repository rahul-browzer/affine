...
**Stage 4 — H18–H20 n80 live; H21/H22 bootstrapping; H23+H24 staged (cap 5/5).**
...
| Lium / spend | ~$32,682 · ~$1,440 · cap rem ~$2,560 |
| miner | τ10.000 free · 0 submissions |
| H18 | n80 ~37/80 @15:47Z (TP×Shatoria α0.75) |
| H19 | n80 ~42/80 @15:47Z (TP×kkkk α0.90) |
| H20 | n80 ~26/80 @15:47Z (TP×leary α0.90; chall@0.72) |
...
| H24 | **staged** TP×0ronoCris α0.90 — after H23 (scripts ready) |
...
(`experiments/s4-h23-tp-talucampe-a90/upload_and_launch.sh`). Next free after
H23 → **H24** (`experiments/s4-h24-tp-ronocris-a90/upload_and_launch.sh`).
