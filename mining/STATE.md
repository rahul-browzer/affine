...
| Lium / spend | **~$189,220** · cum mining ~$5,210 · **avail ~$179.2k** |
| miner | τ10.000 free · 0 submissions |
| H45 | **n80** ~34/80 a203 |
| H46 | **n80** ~15/80 a203 |
| H47 | **n80** ~23/80 a203; TCACHE frozen |
| H48 | **n80** ~1/80 a203 (just launched) |
| H49 | merge writing shard · teacher relaunched p227 |
...
| mine-h49-1 | zesty-shark-45 | 86.38.238.54:40300 | ~13:59Z | H49 merge+teacher↑ |
...
1. H49: poll teacher :8000 promptable → freeze TCACHE; poll merge.done →
   chall serve → n80 (prewarm/retry already armed). Log:
   `s4-h49-…/results/pass227_teacher_recover.md`.
2. H45–H48: poll n80 → `hN_decision.json`.
