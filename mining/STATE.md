...
| Lium | ~$123,535 · burn **$64/h** (≤$833/h) · floor ≥$10k |
| fleet | `mine-crown-1` lunar-orbit-50 8×B300 · TTL→2026-08-11T16:12Z |
| submissions | 0 · hotkey `default` unused |
| board | live duel **chal-00441** (thompsville cgpb8, dispatching) |
| queue | 431→450→451→452→455→456 |
...
| name | SSH | role |
|---|---|---|
| mine-crown-1 | `ssh root@86.38.182.50 -p 40300` | TK@65536 · R2i/k…p + **R2q/saysth** |
...
**Harvest chal-00441** when gzip lands; if hr>0 let **R2i** Talent×thomp fire→n80. Else keep R2k…R2p Reason+ gates; first hr≥**1.5×** → submit. Else **R2q** pure-saysth after chain ends.
