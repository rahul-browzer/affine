...
| Lium / spend | **~$178,704** · cum ~$19,000 · **avail ~$168.7k** |
| miner / burn | τ10 free · 0 sub · **~$223.4/h** (8) ≪$833 · free **12** |
| F38 | chall recover264 |
| F39–F42 | RL / merge / BoN train |
| F43 | **n80 @16/80** (a203) |
| F44 | **online-DPO train live** (pid15018; t/k :8000/:8001=200) |
| F45 | tok DL |
...
| mine-f43-1 | zesty-matrix-8e | 38.255.28.22:20099 | ~20:34Z | F43 **n80 @16/80** |
...
**p517:** F44 teacher :8000=200 → train launched; DEADMAN patched 06:36Z→**20:58Z** (TTL−30m) before post_train.
...
1. **F43**: n80→decision; m>+0.015 → CONFIRM k=4; else REFUTE/tear.
2. **F44**: await train.done → merge → n80 (DEADMAN=20:58Z armed).
