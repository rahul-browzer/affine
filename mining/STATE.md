...
| Lium / spend | **~$179,487** · cum ~$18,209 · **avail ~$169.5k** |
| miner | τ10.000 free · 0 submissions |
| burn | **~$276.8/h** (8 mine-*) ≪ $833/h · free slots **12** |
| n80 | **F22** ~32; **F29** ~50; **F32** ~15; **F33** ~66; **F34** ~41; **F35** ~47; **F36** **just launched** d203 |
| train | **F37** RL steps live (step≥5, mean_r≈0.02) → max 200 |
| p495 | F37 reward steps confirmed; F36 engines200→n80 attempt1 |

## What's running

| name | huid | SSH | TTL | role |
|---|---|---|---|---|
| mine-f22-1 | calm-hawk-98 | 204.9.206.243:40300 | ~14:27Z | F22 n80 ~32/80 |
| mine-f29-1 | gentle-shark-9c | 152.236.142.234:40300 | ~16:26Z | F29 n80 e203 ~50/80 |
| mine-f32-1 | noble-wolf-e8 | 38.255.28.22:20099 | ~16:49Z | F32 n80 ~15/80 |
| mine-f33-1 | golden-matrix-f1 | 3.135.191.208:20127 | ~17:07Z | F33 n80 d203 ~66/80 |
| mine-f34-1 | brave-eagle-b1 | 38.255.28.18:20099 | ~17:10Z | F34 n80 ~41/80 |
| mine-f35-1 | zesty-matrix-04 | 150.136.71.147:20294 | ~17:19Z | F35 n80 ~47/80 |
| mine-f36-1 | zesty-orbit-ff | 86.38.238.54:40300 | ~18:25Z | F36 n80 d203 attempt1 |
| mine-f37-1 | calm-eagle-91 | 152.236.142.241:40049 | ~19:06Z | F37 RL train step≥5 |
...
**p492–495:** F37 teacher-first → TRAIN_LAUNCHED → **reward steps live** (mean_r≈0.02).
**p493:** Trainer mid-ckpt on `/root` = gocryptfs death — `save_strategy=no`; salvage ckpt model shards.
**p495:** F36 recover264 n_so=22 freeze → engines200 → n80 d203 launched.
...
1. **Any n80 decision** (F33 closest ~66/80, then F29/F35): +0.015→CONFIRM else REFUTE+rm.
2. **F36**: watch n80 progress/decision (just launched).
3. **F37**: train→200 → merge → engines → n80. Prefer orthogonal slots over past-king FT.
