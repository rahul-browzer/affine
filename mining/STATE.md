...
| Lium / spend | **~$189,163** · cum mining ~$5,300 · **avail ~$179.2k** |
| miner | τ10.000 free · 0 submissions |
| H45 | **n80 b203** attempt 2/3 just up (a203 teacher 400) |
| H46 | **n80** ~45/80 a203 |
| H47 | **n80** ~55/80 a203; TCACHE frozen |
| H48 | **n80** ~40/80 a203 |
| H49 | **chall recover p229** loading; FALSE_PROBE a203 |
...
| mine-h49-1 | zesty-shark-45 | 86.38.238.54:40300 | ~13:59Z | H49 chall recover |
...
1. H49: wait `DONE_LAUNCH` in `/root/logs/h49_chall_recover_pass229.log`
   → n80 rearm; detail `s4-h49-…/results/pass229_chall_recover.md`.
2. Poll H45–H48 → `hN_decision.json` (H47 closest ~55/80).
