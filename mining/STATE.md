...
| B300 stock | **0** free 8×B300/B200 (burst+waiter STOP) |
| Lium bal | ~$117,983 · floor $10k OK |
| submissions | 0 |
| R15 | **CPU merge writing** ~**38%** shard1 (blocks↑; pid**80751**) |
| R17 | **training** coder-REINFORCE crown ~step **115**/200 |
| R20 | **training** kevin-GRPO mine-r4 ~step **84**/200 |
...
**R15:** wait merge.done (blocks↑ on `.tmp*`) → chall:8002 → n80 vs ckp333 (hr≥1.5×).
