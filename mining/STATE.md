...
**Stage 4 in progress — H2 α=0.5 sim duel RUNNING vs kevin (sampling ~15/80).**
...
| Lium balance | $34,594.06 (floor $28,000) |
| miner coldkey free | τ10.000 (unchanged) |
| mining spend to date | `mine-sim-1` spent **$29.09** @ $23.60/h (TTL cap ≈ $141.60) |
...
| Stage 4 H2 sim | **RUNNING** — pid **68843**; log @ 00:07Z: `king 15/80`, `challenger 15/80` |
...
- Progress (pass 13): sampling advancing; teacher GPUs 0–1 ~100% (bottleneck:
  ~7–9 running / ~14–20 waiting); king/chall engines loaded, idle between batches
- Throughput: ~5 turns / ~2–2.5 min per side after bootstrap → sampling ETA
  ~00:30–00:40Z; force-echo after that; finish well inside TTL 04:53Z
...
Nothing hard. Soft: TTL ends 04:53Z (~4.75h left @ 00:07Z). Do **not**
