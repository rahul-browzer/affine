...
**Stage 4 — H12 REFUTED; H13–H16 n80; H17 merge.**
...
| Lium / spend | $32,941 · ~$1,100 · cap rem ~$2,900 |
| miner | τ10.000 free · 0 submissions |
| H13 | n80 **72/80** (nearest finish) |
| H14 | n80 ~40/80 |
| H15 | n80 ~30/80 |
| H16 | teacher recovered 14:29Z; n80 retry 1/3 live |
| H17 | merge ~12/16 shards |
...
| mine-h17-1 | cosmic-orbit-9b | 38.255.28.21:20099 | 21:56Z | H17 merge→serve |
...
**Poll nested `*_decision.json` (H13 first — ~72/80).** On REFUTE:
`lium rm` that `mine-h*-1` only. If H13 ADVANCE → tear H17. If H13
band-INVALID → keep H17. Free slot → Shatoria α0.75. TRY_ALPHA_095 if
gate-valid and 0.02≤m≤0.04; ADVANCE if m>0.04. Confirm H16 progress
after teacher recover (`h16_sim_progress.json`).
