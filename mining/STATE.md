...
| B300 stock | **0** free 8×B300/B200 (burst p2202 ~iter1720) |
| Lium bal | ~$117,920 · floor $10k OK |
| submissions | 0 |
| R15 | **n80 RUNNING** pid**87097** vs ckp333 (chall PROMPTABLE 08:10Z) |
| R17 | **training** coder-REINFORCE crown ~step **140**/200 |
| R20 | **training** kevin-GRPO mine-r4 ~step **117**/200 |
...
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **R15** n80 vs ckp333 |
...
R15 n80: `tail -f /root/logs/h135_sim.nohup` · progress `/root/affine_data/h135_sim_progress.json`
R17: `tail -f /root/logs/h135_train.nohup` · R20: `tail -f /root/logs/r3_train.nohup`
Burst: `tail -f experiments/fleet-rent/logs/burst_p2202.log`
...
## Next action
**R15:** wait n80 → `h135_sim_result.json` / decision (hr≥1.5× → submit path; else REFUTE).
