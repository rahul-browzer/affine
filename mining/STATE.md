...
| B300 stock | **0** free 8×B300/B200 · fleet →`mine-r7-datafilt-1` @POLL=**1s** |
| Lium bal | ~$120,195 · floor $10k OK |
| submissions | 0 |
...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bf** n80 ~39/80 dpo2@90ea78ff |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **R3b** GRPO sole pid**51672** @step1+ |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R6** train ~7/96 @max_len16384 |
| host fleet-rent | pid**2690014** | — | blind-fire →25 @POLL=**1s** next=**R7** |
...
R3b: `tail -f /root/logs/r3_train.nohup` · dedupe `r3b_dedupe_p2128.json` · pipe `r3b_pipeline.nohup`
...
**p2128:** killed R3b orphan train **51496** (kept **51672**); GPU6/7 76→37 / 82→41 GiB; fleet POLL 10→**1s**. B300×8=0.

## Blocked
No free 8×B300/B200. Cannot hit $833/h burn until stock returns.

## Next action
**Rent:** snatch next B300 → `mine-r7-datafilt-1` (blind-fire@1s).
