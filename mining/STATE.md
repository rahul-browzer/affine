...
| Lium / spend | **~$183,317** · cum ~$14,095 · **avail ~$173.3k** |
| miner | τ10.000 free · 0 submissions |
| burn | **~$151.5/h** (4 mine-*) ≪ $833/h · free slots **16** |
| F4 | teacher recover332 **promptable**; n80 **a203** running (resumed 23:24Z) |
| F7 | n80 **c203** king3/chall5 (b203→400 rotate; FALSE_PROBE≠REFUTE) |
| F8 | n80 a203 **king43/chall43** |
| F9 | n80 b203 **king54/chall54** |
...
**Teacher mid-n80 bare `cache/teacher` → Triton ENOENT** — recover332 unique TCACHE (p406); **promptable+n80 resume p407**.
...
1. **Await n80 margins** — F9 nearest (~54/80); F8 ~43; F4 early a203; F7 c203 early.
2. On first screen **m>+0.015** → rent CONFIRM k=4 immediately.
3. On REFUTE (m≤0 or gate fail) → tear that pod; fill slot if open family exists.
4. F7 chall-400 churn: if c203 also FALSE_PROBE → chall recover264 (not REFUTE).
