...
| B300 stock | **0** free 8×B300/B200 (API n8=42, all taken) |
| Lium bal | ~$119,673 · floor $10k OK |
| submissions | 0 |
...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bj** n80 ~10/80 + **R9** LoRA train |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **R3b** GRPO ~step64 |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R6b** n80 live ~28/80 |
| host fleet-rent | pid**2840405** | — | **api-POST-rent** (single; R7 next) |
...
R6b: `cat /root/affine_data/h101_sim_progress.json` · dec `h101_decision.json` · Soft=Aug12T23:28Z
Fleet: `tail -f experiments/fleet-rent/logs/wait_fleet_b300.log`
**p2150:** killed dual snatcher pid**2895885** (`--help`→main); single-instance+Tee fix; R6b n80 ~28/80; B300×8=0; burn **$180.25/h**.
...
**R6b:** wait n80 → `h101_decision.json`.
