...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bb DONE** WEAK; next **R2bc** (ec08/ckp55) |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | GRPO pid28660 step≥**135**/200 + wedge |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R4** chall recover@**65536** + n80 retry **armed** |
...
R4: recover pid**15351** · n80 pid**15359** · `tail -f /root/logs/{h121_chall_recover_pass264,h121_n80_retry}.nohup`
...
## Blocked
No free 8×B300/B200. p2113 rent miss; blind-fire continues. Next rent = **R5**.

## Next action
**Rent:** snatch next B300 → `mine-r5-nonking-1` (blind-fire@0).
**R4:** wait TKC healthy@65536 → n80 (watcher armed).
**Crown:** arm **R2bc** (ec08/ckp55 after R2bb WEAK).
**R3:** train.done→n80 (step≥135/200).
