...
| Lium | ~$123,400 · burn **$64/h** (≤$833/h) · floor ≥$10k |
...
| **R2t** | saysth×Talent **n80 RUNNING** ~**3/80** (Δ=**0.207**) |
...
- R2t: `launch_r2t_merge_reload_sim.sh` pid 176482 · sim pid **182566**.
- Progress: `/root/affine_data/r2t_alpha_reason_progress.json` (~3/80).
