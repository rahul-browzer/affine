...
| Lium / spend | **~$186,955** · cum ~$9,290 · **avail ~$177.0k** |
| miner | τ10.000 free · 0 submissions |
| H75 | **REFUTE** m=+0.000550 z=0.101 vs Tok (torn) |
| H76 | king300 loading → retry n80 a203 |
| H77 | n80 vs Tok a203 running (post recover264) |
| H78 | recover264 diverse warm → freeze → n80 |
| H79 | train_lora Tok-init@r18 (pid live) |
| H80 | **NEW** Tok-init@r17 bootstrap pip |
...
| mine-h77-1 | eager-shark-64 | 152.236.142.237:40306 | ~23:44Z | **n80 vs Tok** |
| mine-h78-1 | eager-comet-a4 | 38.255.28.22:20100 | ~23:44Z | recover264 warm→n80 |
| mine-h79-1 | lunar-shark-be | 152.236.142.232:40100 | ~00:18Z+1d | train Tok-init r18 |
| mine-h80-1 | eager-shark-18 | 152.236.142.236:40311 | ~00:26Z+1d | bootstrap Tok-init r17 |
...
**m7×r18 closed for new rents** (H72/H74/H75 all m≈≤0 vs Tok; H76 finishes last draw).
...
1. H76: await king300 PROMPTABLE → retry n80 a203 → `decision.json`.
2. H77: await n80 `decision.json` vs Tok.
