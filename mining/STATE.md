...
| n80 | F10~57 F11~62 F13~17 F14~29 F15~23 |
| other | F16 **merge**; F17/F20 chall pending; F18/F21/F22 **boot**; F19 **n80**; F23 **boot** B300 |
...
| mine-f20-1 | lunar-raven-37 | 152.236.142.235:40301 | ~14:15Z | F20 **serve** T+K |
...
**p445:** H200/B200 empty → B300 COUNT=8 @$63.60 for F23 raw-Bittob.
...
1. **Poll F10/F11/F13–F23** → >+0.015 CONFIRM k=4; ≤0 REFUTE+tear.
2. Hold CONFIRM slots until a screen clears +0.015.
3. If slot frees: rent next raw-base (**af-k1 unmodified** / F5 if traj ready).
4. Watch F21 B200 + F22/F23 B300 for SM/CUDA — tear if unrecoverable.
