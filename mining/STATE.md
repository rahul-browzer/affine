...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2av** v2 n80 ~63/80; R2ax armed |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **GRPO** pid15121 @ step≥10; teacher:8000 + king:8001@**65536** |
...
R3 check: `tail -f /root/logs/r3_train.nohup` · engines `curl :8000/:8001/health`
p2062: king reloaded 65536; teacher recovered (NCCL orphan); GRPO SIGSTOP/CONT during reload.
...
**R3:** watch GRPO steps/loss → `train.done` → post_train merge+chall+n80 (king already 65536).
**Crown:** collect R2av decision; R2ax tt auto-continues.
