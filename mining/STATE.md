...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bi** mt2 prefetch→reload/n80 + **R9** LoRA train GPUs6–7 |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **R3b** GRPO ~step47 |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R6b** long-z LoRA ~step31/132 |
...
**p2145:** R2bh REFUTE (m=+0.00378 z=1.16 <2σ); armed **R2bi** thrivepath mt2@22a5d514; B300×8=0; burn **$180.25/h**.
...
**Crown:** wait R2bi prefetch→chall reload→n80 → `r2bi_mt2_decision.json` (Glm4Moe may UNSERVABLE).
