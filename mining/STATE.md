...
| Lium / spend | **~$183,967** · cum ~$13,350 · **avail ~$174.0k** |
| miner | τ10.000 free · 0 submissions |
| burn | **~$213/h** (6 mine-*) ≪ $833/h · free slots **14** |
| F1 | n80 vs Tok **~12/80** (engines 200) |
| F4 | Tok Range shard2 ~79%; teacher 200; king/chall down |
| F6 | a2 shards loaded; profile/compile; :8002=000; n_so=20 |
| F7 | salvage unfrozen (p386); weight load ~36 GiB; n80 retry waiting |
| F8 | RL train live (max_steps 200) |
| F9 | kevin LoRA train live (DL done); teacher.done; Tok incomplete |
...
| mine-f6-1 | noble-shark-14 | 152.236.142.237:40300 | ~08:42Z+1d | F6 a2 →n80 |
| mine-f7-1 | lunar-shark-87 | 152.236.142.232:40311 | ~08:52Z+1d | F7 salvage→n80 |
...
**F6:** a2 loading post peer-seed; await :8002=200 → warm/freeze → n80.
**F7:** salvage was 555-hung; unfroze p386 — leave writable until health+warm; n80 will rotate block_hash.
...
1. **F7** await salvage :8002=200 → promptable×2 → n80 (b203+).
2. **F6** await a2 :8002=200 → warm/freeze → n80.
3. **F1** await n80 margin vs Tok.
4. **F4** await `tok331102.done` → king+chall → n80.
5. **F8/F9** train→merge→n80.
