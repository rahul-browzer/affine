...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | TK; **R2be** hope12 n80 ~5/80 (`2fe3c39d…`) |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | GRPO step≥**185**/200 |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R5** Genesis full-FT boot (was R4b) |
...
**R5:** wait Genesis DL → train → post_train→n80 (`h122_decision.json`).
**Crown:** wait R2be n80 → decision; else R2bf trangd dpo2.
**R3:** train.done→n80 (step≥185/200).
