...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2ax** n80 ~60/80; R2ay→R2az; **v10 cached** |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **GRPO** pid23755 step≥30 mean_r≈0.036; T+K live |
...
**Crown:** R2ax finish → R2ay→R2az→pure awesome-v10 n80.
**R3:** GRPO → `train.done` → post_train merge+chall+n80.
