...
| Lium | ~$123,008 · burn **$64/h** (≤$833/h) · floor ≥$10k |
| fleet | `mine-crown-1` lunar-orbit-50 8×B300 · TTL→2026-08-11T16:12Z |
| submissions | 0 · hotkey `default` unused |
| live eval | chal-**00455** sth **scoring** ~43/80 · queue cp200→whoami→v8→tpc9 |
| disk | `/root` **~643 GiB** free · R2y eager ~70 GiB |
| **R2n** | Talent×asdf **REFUTE** hr **−1.07×** (purged) |
| board 450/451/452 | sft3 **0.37×** / asdf **0.40×** / zeus **0.25×** — all <1.5× |
| **R2o** | Talent×zeus **n80 ~26/80** · holding stamp · Stage-5 not armed |
...
| name | SSH | role |
|---|---|---|
| mine-crown-1 | `ssh root@86.38.182.50 -p 40300` | TK@65536 · **R2o n80** · R2x/R2y eager waiting Reason+ |
...
**Harvest R2o** n80 vs Tok; if hr≥1.5× → arm Stage-5 HF push then register+`--check`+submit; if 0<hr<1.5 keep blend and queue next Reason+ parent (R2p sth / R2m cp200 / R2x if 462+ / R2y if 463+); if hr≤0 purge R2o blend and advance next ready lane.
