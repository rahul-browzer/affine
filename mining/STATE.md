...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bh** IntoLayer n80 ~25/80 |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **R3b** GRPO ~step39 |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R6** n80 **~40/80** (post_train; continue exited) |
...
R6: `tail -f /root/logs/h101_sim.nohup` · progress `h101_sim_progress.json` · dec `h101_decision.json`
Fleet: `tail -f experiments/fleet-rent/logs/wait_fleet_b300.log`
**p2142:** R6 chall healthy→n80 live (~40/80, corpus epoch8); deadman patch held; API B300×8=0; burn **$180.25/h**.
...
**R6:** wait n80 → `h101_decision.json` (progress ~40/80).
