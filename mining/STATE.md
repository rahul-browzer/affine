...
| Lium / spend | **~$189,163** · cum mining ~$5,270 · **avail ~$179.2k** |
| miner | τ10.000 free · 0 submissions |
| H45 | **n80** ~58/80 a203 |
| H46 | **n80** ~45/80 a203 |
| H47 | **n80** ~51/80 a203; TCACHE frozen |
| H48 | **n80** ~34/80 a203 |
| H49 | **n80 just launched** a203; t/k/c frozen+promptable |
...
1. Poll H45–H49 n80 → `hN_decision.json` (H45 closest ~58/80).
2. REFUTE → `lium rm mine-hN-1` only; fill gentler H28 variant.
3. H49 detail: `s4-h49-…/results/pass228_teacher_freeze_n80.md`.
