...
| **R2g Talent×saysth** | **MERGING** · α Talent0.25/saysth0.75 · ~11/16 shards · waiter→reload+n80 |
| R2i Talent×thomp | gated on 441 Reason+ (queue #1 after 432) |
| BKN seven | cached · watch **140530** · live eval now |
| **BKN six** | **PREFETCHING** · chal-00431 · `a12fc171e1bb…` · pid **142256** |

## What's running

| name | huid | SSH | TTL | role |
|---|---|---|---|---|
| mine-crown-1 | lunar-orbit-50 | `ssh root@86.38.182.50 -p 40300` | 2026-08-11T16:12Z | TK@65536 · R2g merge · R2i/441 · BKN/432 · prefetch BKN6 |

- Engines 8000/8001/8002 **200** (chall still on R2h path until R2g reload).
- R2g: merge **130003** → `/root/r2_out/alpha_talent_saysth_v9a_skew`; waiter **130835**.
- BKN six prefetch: `tail /root/logs/r2_prefetch_bkn_six.log`; done → `r2_prefetch_bkn_six.done`.
- Check R2g: `r2g_alpha_decision.json`. Check 432/441: `chal00432_reason.json` / `chal00441_reason.json`.
...
**Wait R2g** merge DONE → chall reload → n80 → harvest `r2g_alpha_decision.json`. Submit only if hr ≥ **1.5×**. If R2g fails: gate **R2i** on 441 Reason+; harvest BKN `chal00432_reason.json`; confirm BKN-six prefetch DONE before next queue parent.
