...
| R24 | train~**155**/200; post_train waiter live |
| R25 | train~**144**/200; post_train waiter live |
| R33 | guass-init GRPO **step~4**/200 on crown (pid364476) + T/K warm |
| R5b | **recovered** p2236: ENOSPC reclaim → Talent DL relaunch (pid151889) |
...
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R5b** Talent DL→full-FT (disk fixed) |
...
## Next action
1. Confirm R5b Talent DL done → full-FT train; watch R33 step→merge→n80 vs guass.
