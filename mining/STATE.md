...
| Lium / spend | **~$183,377** · cum ~$14,035 · **avail ~$173.4k** |
| miner | τ10.000 free · 0 submissions |
| burn | **~$151.5/h** (4 mine-*) ≪ $833/h · free slots **16** |
| F4 | **n80 a203** (cuda404 cleared; freeze 555/22; duel pid97694) |
| F7 | n80 **b203** (c203→b203 rotate; progress file fresh) |
| F8 | n80 a203 ~king29/chall28 |
| F9 | n80 b203 **king36/chall36** of 80 |
...
1. **F4/F7/F8/F9** await n80 margins (all four screening).
2. On first screen **m>+0.015** → rent CONFIRM k=4 immediately (do not wait for others).
3. On REFUTE (m≤0 or gate fail) → tear that pod; fill slot with next open family if any.
