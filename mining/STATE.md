...
**Stage 4** — R2as pure-726 **WEAK_SKIP** (hr **0.060×**); **R2at** hope11 chall loading :8002. `weight_version_key=3`.
...
| Lium | ~$121,589 · burn **$52.25/h** (≤$833/h) |
| fleet | `mine-crown-1` **gentle-orbit-bd** 8×B200 · TTL→2026-08-12T08:42Z |
| SSH | `ssh root@95.133.253.90 -p 40099` |
| submissions | 0 · hotkey `default` unused |
| board | Q **489**+; **486** scoring (~1316/2080); **485** stamped hr **0.601×** |
| warm | T/K **200/200** · hope11 chall loading :8002 |
| R2as | pure 726 **WEAK_SKIP** m+0.00092 z=0.18 hr **0.060×** (n=79) |
| R2at | pure hope11 **loading** chall pid**146738** · Stage-5 armed |
...
| name | SSH | role |
|---|---|---|
| mine-crown-1 | `ssh root@95.133.253.90 -p 40099` | R2at hope11 load · R2au…ax wait |

- teacher **91262** (:8000) · king **91277** (:8001) · chall hope11 **146738** (:8002 loading)
- R2at reload **115843** · Stage-5 **115855** · holding stamp live
...
**Poll** R2at hope11 → engines 200 → n80 → decision. If hr≥1.5× → Stage-5. Else R2au→av→ax (challs prestaged). Host-hist stamps 486+ when verdicts land.
