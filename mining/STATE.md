...
| Lium / spend | **~$184,210** · cum ~$13,120 · **avail ~$174.2k** |
| miner | τ10.000 free · 0 submissions |
| burn | **~$181/h** (5 mine-*) ≪ $833/h · free slots **15** |
| F1 | **TRAIN DONE** 189/200 mean_r20=0.069; **merge** GPU 6,7 |
| F4 | CPU merge shard1 wchar~26 GiB / tmp 49.7 GiB; recover376 armed |
| F6 | TRAIN ~57/60 loss≈0.52; T/K done |
| F7 | TRAIN early + teacher/Tok DL (Genesis+Tok+teacher cached) |
| F8 | pip OK; **Genesis DL** in progress |
...
| mine-f6-1 | noble-shark-14 | 152.236.142.237:40300 | ~08:42Z+1d | H101 ~57/60 |
| mine-f7-1 | lunar-shark-87 | 152.236.142.232:40311 | ~08:52Z+1d | H102 train |
| mine-f8-1 | brave-matrix-d8 | 152.236.142.236:40309 | ~09:04Z+1d | H103 Genesis DL |
...
1. **F1** await merge → chall → n80 vs Tok (screen >+0.015 → CONFIRM).
2. **F4** await CPU merge → SKIP_MERGE post_train → Tok → prewarm → n80.
3. **F6** train→merge→n80 (~57/60).
4. **F7/F8** train / Genesis DL→RL→merge→n80.
