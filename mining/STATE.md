...
| R1c train | **RUNNING** · **~56/132** @~36s/it · pid **96239** · ETA ~45m |
| R1c merge waiter | **ARMED** · pid **97305** · R1b below bar → merge after train |
| R2 α→n80 | **WAITING** · pid **99246** · r1b_dec=y r1c_dec=n |
| Near-miss prefetch | **RUNNING** · pid **99742** · awesome-v6 ~26 GiB (10/11 files) |
| R2b Tok×awesome premerge | **ARMED** · pid **100240** · waits `r2_prefetch_nearmiss.done` |
...
|---|---|---|---|---|
| mine-crown-1 | lunar-orbit-50 | `ssh root@86.38.182.50 -p 40300` | 2026-08-11T16:12Z | TK@65536 + R1c + R2 + R2b premerge |
...
- R2b: `/root/logs/r2b_premerge.{pid,log}` → `r2b_premerge.done` + `/root/r2_out/alpha_tok_awesome_v6`.
...
**Harvest** `/root/affine_data/r1c_lora_decision.json`. If headroom ≥ 1.5× → Stage-5. Else let R2 α→n80 finish, harvest `r2b_premerge.done` (Tok×awesome), then arm R2b chall reload+n80.
