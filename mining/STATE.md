...
| Lium / spend | **~$189,795** · cum mining ~$4,320 · **avail ~$179.8k** |
| miner | τ10.000 free · 0 submissions |
| H37 | n80 a203 @ **66**/80 |
| H38 | n80 a203 @ **67**/80 |
| H39 | n80 a203 sole @ **12**/80 |
| H40 | chall relaunch p212 (triton race); retry wait poll0 |
| H41 | merge.done; chall loading GPUs4/5 ~38GiB; disarm armed |
...
| mine-h41-1 | zesty-lion-26 | 38.255.28.19:20099 | ~11:14Z | H41 chall→disarm→n80 |
...
`disarm_bare_n80_pass211.sh`. H40 p212 killed post_train wait.

## Next action

1. H37/H38: poll n80 → decision. Margin >0.04 → Stage 5.
2. H39: poll a203 n80 → decision.
3. H40: wait chall promptable (recover p212) → retry hashed n80.
   Log: `/root/logs/h40_chall_recover_pass212.log`.
4. H41: wait CHALL_SERVE_DONE → disarm kills post_train → retry n80.
   REFUTE → `lium rm mine-hN-1` only; fill non-α H28.
