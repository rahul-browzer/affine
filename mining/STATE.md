...
| Lium / spend | **~$182,028** · cum ~$15,720 · **avail ~$172.0k** |
| miner | τ10.000 free · 0 submissions |
| burn | **~$456.4/h** (13 mine-*) ≪ $833/h · free slots **7** |
| n80 | F10~62 F11~67 F13~28 F14~36 F15~30 F19~1 |
| other | F16 **merge**; F17/F20 **chall relaunch p446**; F18/F21/F22/F23 **boot** |
...
| mine-f11-1 | swift-eagle-51 | 152.236.142.237:40300 | ~12:02Z | F11 **n80** |
...
| mine-f17-1 | eager-eagle-f3 | 38.255.28.18:20099 | ~14:02Z | F17 **chall load** p446 |
...
| mine-f20-1 | lunar-raven-37 | 152.236.142.235:40301 | ~14:15Z | F20 **chall load** p446 |
...
| mine-f23-1 | lunar-matrix-eb | 204.9.206.244:40301 | ~14:31Z | F23 **bootstrap** B300 |
...
**p446:** F20 FALSE_PROBE ConnectError + chall KeyError → relaunch_072; F17 Triton ENOENT hang → reap+king-seed+relaunch.
...
1. **Confirm F17/F20** :8002=200 + n80 progress; if chall dies again → recover264-style (writable warm→freeze).
2. **Poll F10/F11/F13–F15/F19** → >+0.015 CONFIRM k=4; ≤0 REFUTE+tear.
3. Hold CONFIRM slots until a screen clears +0.015.
4. If slot frees: rent next raw-base (**af-k1 unmodified** / F5 if traj ready).
5. Watch F21 B200 + F22/F23 B300 for SM/CUDA — tear if unrecoverable.
