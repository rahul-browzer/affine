...
| B300 stock | **0** free 8×B300/B200 (p2183 150-iter burst + waiter) |
| Lium bal | ~$118,943 · floor $10k OK |
| submissions | 0 |
...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bn** n80 ~35/80; **R9** LoRA ~340/354; post R2bn-gated |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **R3b** GRPO ~step157/200 |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R12** BoN-CE ~step75/150 |
...
**p2183:** `SKIP_PID_LOCK` pass-burst (STOP waiter→150 iters→CONT); stock empty. Crown Removal **2026-08-13T02:35:59Z**.
...
Fleet: `tail -f experiments/fleet-rent/logs/wait_fleet_b300.log` · burst `…/burst_p2183.log`
