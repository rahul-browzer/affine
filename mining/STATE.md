...
(n80 sim RUNNING attempt 1/3, ~47/80).**
...
pid **276121** advancing king**47**/chall**47** @ 09:07:03Z
(window ~1.94 tpm → ETA **~09:24Z**; wall-90s ~1.24 tpm). Advancing.
No submit.
...
| Lium balance | $33,753.43 (floor $28,000) |
| miner coldkey free | τ10.000 (unchanged) |
| mining spend to date | `mine-sim-1` spent **~$242** @ $23.60/h |
| our submissions | none |
| Stage 3 gate | **MET** |
| H2 / H1 / H1v2 / H5 merge | **all REFUTED** |
| H5b | **open** — n80 running (king47/chall47 @ 09:07Z; ETA ~09:24Z) |
...
- n80 sim pid **276121** (`run_sim_duel.py` attempt **1/3**); out
  ...
  `/root/affine_data/h5b_sim_progress.json` (king **47**/chall **47** @ 09:07:03Z)
- Rate: window ~1.94 k-tpm (pass96→97); wall-90s ~1.24 → ETA
  **~09:24Z**; deadman slack OK (~156 min vs window ETA)
...
- Evidence: `results/h5b_sim_progress.json`, `h5b_time_budget_pass97.json`
...
Nothing hard. **Do not submit** H1/H1v2/H2/h5-kt*/h5b HF salvage. Cap remaining ~$3,758.
Ignore archived false abort. ETA n80 done ~09:24Z (window ~1.94 tpm; slack to deadman OK).
