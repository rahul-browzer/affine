...
| B300 stock | **0** free 8×B300/B200 (long burst R27) |
| Lium bal | ~$117,485 · floor $10k OK |
| submissions | 0 |
| crown / R26 :8001 | **guass** · teacher **65536** |
| R3 / R24 | train~**91**/200; teacher **32768** + tmax**96210**; post**96662** n80-gate |
| R25 | train~**56**/200; guass :8001; teacher **65536**; post**19722** |
| R17 | **REFUTE** vs guass m=−0.014 (p2210) |
| R20 | **REFUTE** vs guass m=**−0.0196** z=−2.13 (p2211) |
| R21 | train~**92**/200; teacher **65536**; post**143108** |
| R24 | post n80 waits teacher **≥65536** (p2221 gate) |
| R26 | train~**83**/200 LoTemp; post**356966** |
...
| host fleet-burst | pid**3725622** | — | **86400**-iter snatch next **R27** (p2222) |
...
Burst: `tail -f experiments/fleet-rent/logs/burst_p2222.log`
...
## Next action
**Rent:** keep burst **3725622** (86400) snatching **R27**; CONT **3373328** only if it exits.
