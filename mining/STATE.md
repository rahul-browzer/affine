...
| F9 / F4 | n80 d203 **~65/80** · **~60/80** (nearest screens) |
| F10 / F11 | n80 d203 just launched · merge live |
| F12 / F13 | train ~step50 · train + Tok DL |
| F14 / F15 | bootstrap Bittob · **bootstrap everest (p421)** |
...
1. **Await F9 screen** (~65/80) → m>+0.015 CONFIRM k=4; m≤0/gate → tear.
2. Then F4 (~60/80). F10 n80; F11 merge→n80; F12–F15→n80.
3. Free slot: rent **F16** (af-k1) if burn≪833 and no CONFIRM demand;
