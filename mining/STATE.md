...
| Lium / spend | **~$180,428** · cum ~$17,267 · **avail ~$170.4k** |
| miner | τ10.000 free · 0 submissions |
| burn | **~$359.0/h** (11 mine-*) ≪ $833/h · free slots **9** |
| n80 | none mid-flight (F28 engines loading; F26 serve_three) |
| other | F22 Tok Range ~95%/84%; F26 merge.done→serve; F27/F29–F35 train |

## What's running

| name | huid | SSH | TTL | role |
|---|---|---|---|---|
| mine-f22-1 | calm-hawk-98 | 204.9.206.243:40300 | ~14:27Z | F22 Tok Range ~95% → serve→n80 |
| mine-f26-1 | gentle-fox-2c | 152.236.142.235:40300 | ~16:12Z | F26 **serve** (p473 salvage; merge OK) |
| mine-f27-1 | eager-orbit-15 | 152.236.142.237:40299 | ~16:16Z | F27 full-FT **train** (train_full symlink-patched) |
| mine-f28-1 | eager-eagle-b1 | 152.236.142.232:40300 | ~16:20Z | F28 engines loading → n80 |
...
p472/p473: never copytree `/tmp`→gocryptfs `/root`; symlink only.
...
1. F28: poll 8000/8001/8002=200 + chall completions → confirm n80; read margin.
2. F26: engines→n80 (merge.done; serve_three live).
3. F22: Tok Range finish→tok.done→serve→n80.
4. F27/F29–F35 train.done→finalize `/tmp` (symlink-patched). Free slot → af-k1 dense-FT.
