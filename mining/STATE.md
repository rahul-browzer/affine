...
| Lium | ~$123,099 · burn **$64/h** (≤$833/h) · floor ≥$10k |
| fleet | `mine-crown-1` lunar-orbit-50 8×B300 · TTL→2026-08-11T16:12Z |
| submissions | 0 · hotkey `default` unused |
| live eval | chal-**00452** zeus @ scoring chall **39**/80 · queue sth→cp200→whoami→v8→tpc9 |
| disk | HF hub **701 GiB** (−281 GiB p1959 purge) · `r2_out` 66 GiB (R2n only) |
...
| **R2n** | Talent×asdf **n80 ~13/80** · chall pid **220421** · sim **224186** |
...
| name | SSH | role |
|---|---|---|
| mine-crown-1 | `ssh root@86.38.182.50 -p 40300` | TK@65536 · **R2n n80** · R2m/o/p/r/x/y wait |
...
**Harvest R2n** n80 vs Tok; if hr≥1.5× → Stage-5 HF push then register+`--check`+submit; if 0<hr<1.5 keep blend as best-so-far and let next Reason+ lane (R2o when 452 lands, else R2m/p/r/x/y) take chall; if hr≤0 purge R2n blend (`alpha_talent_asdf_skew`) and advance. R2x/R2y stay gated on 462/463 Reason+.
