...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | R2ay WEAK; **R2az** n80 ~40/80 |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | GRPO pid28660 step≥36; wedge-watch |
| host fleet-rent | pid**2277571** | — | rent →**25** mines (R4…R12) |
| host fleet-boot | pid**2277625** | — | auto-upload **R4–R12** |
...
**Bootstrapped rented_mine-r{4..12}*:** watch axis train log.
**Else rented without boot:** fleet-boot log (auto R4–R12).
**R3:** steps→train.done→post_train n80.
**Crown:** R2az n80 → decision → awesome-v10.
**New axes:** invent next distinct axis beyond R12 if stock appears and queue empties.
