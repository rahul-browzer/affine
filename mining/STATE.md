...
| R24 | train~**175**/200; post_train waiter live |
| R25 | train~**168**/200; post_train waiter live |
| R33 | guass-init GRPO **step~48**/200 on crown + T/K warm |
| R5b | **n80 armed** (p2239): form+watch+retry waiting T/K/C PROMPTABLE vs guass |
...
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R5b** T/K/C loading → n80 vs guass |
...
R5b pids: form**161132** watch**161150** retry**161164**
...
## Next action
1. R5b: wait retry PROMPTABLE → n80 vs guass; CLEAR → Stage-5.
