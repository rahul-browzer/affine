...
| challenge | chal-**00517** scoring |
| miner burn | **$180.25/h** · floor $833/h · **gap −$653/h** |
| B300 stock | **0** free 8×B300/B200 (p2193 1200-iter burst) |
| Lium bal | ~$118,337 · floor $10k OK |
| submissions | 0 |
| R14 | **training** kevin-REINFORCE on mine-r4 ~step **185**/200 |
| R15 | **training** pandora-REINFORCE on mine-r3 ~step **70**/200 |
| R16 | **training** golden-REINFORCE on mine-crown ~step **170**/200 |
...
| host fleet-rent | pid**3373328** | — | api-POST-rent; next=**R24** |
...
R16: `tail -f /root/logs/h135_train.nohup` · post `/root/logs/r16_post_train.nohup`
