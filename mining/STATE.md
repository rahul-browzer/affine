...
| challenge | chal-00499 scoring (~1740/2080); queue +chal-00516 IntoLayer |
| miner burn | **$180.25/h** · floor $833/h · **gap −$653/h** |
| B300 stock | **0** free 8×B300/B200 · fleet **api-POST-rent** pid**2784801** |
| Lium bal | ~$119,903 · floor $10k OK |
| submissions | 0 |
...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bh** IntoLayer n80 ~12/80 |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **R3b** GRPO ~step36 |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R6** merge→chall→n80 (continue armed) |
...
R6: `tail -f /root/logs/h101_pipeline.nohup /root/logs/h101_continue_n80_p2141.nohup` · dec `h101_decision.json`
Fleet: `tail -f experiments/fleet-rent/logs/wait_fleet_b300.log`
**p2141:** R6 train.done@00:13Z → merge save; patched deadman + continue n80 (stale Aug-9 would skip); B300×8=0; burn **$180.25/h**.
...
**R6:** wait merge→chall→n80 (continue covers stale deadman) → `h101_decision.json`.
