...
| B300 stock | **0** free 8×B300/B200 (p2186 400-iter burst) |
| Lium bal | ~$118,860 · floor $10k OK |
| submissions | 0 |
...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bn REFUTE**; **R9** merge→reload→n80 |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **R3b** GRPO ~step164/200 |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R12** BoN-CE ~step100/150 |
...
**p2186:** R2bn n80 **REFUTE** m=−0.00733 z=−1.55 hr=−0.78×(2σ). R9 merge started 04:27Z GPUs6–7.
R9: `tail -f /root/logs/r9_post_train.nohup` · merge pid on crown
R12: `tail -f /root/logs/h137_train.nohup`
R3b: `tail -f /root/logs/r3_train.nohup` · Soft 15:29Z / Dead 15:59Z
Fleet: `tail -f experiments/fleet-rent/logs/wait_fleet_b300.log` · burst `…/burst_p2186.log`
...
**R9:** wait merge→graft→chall reload→n80 vs ckp333 (hr≥1.5× live 2σ).
