...
| R24 | train~**162**/200; post_train waiter live |
| R25 | train~**151**/200; post_train waiter live |
| R33 | guass-init GRPO **step~16**/200 on crown + T/K warm |
| R5b | **train DONE** → finalize OK → T/K/C serve arming for n80 vs guass (p2238) |
...
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R5b** Talent FT → merged + serve→n80 |
...
R5b serve: `tail -f /root/logs/h122_post_train.nohup` · R33: `tail -f /root/logs/r3_train.nohup`
...
## Next action
1. R5b: wait T/K/C PROMPTABLE → n80 vs guass; CLEAR → Stage-5.
