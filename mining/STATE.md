...
| challenge | chal-00499 load_challenger; queue 501/502/504/508/511/**514** |
| miner burn | **$180.25/h** · floor $833/h · **gap −$653/h** |
| B300 stock | **0** free 8×B300/B200 · fleet **B300-only ×22** @POLL=0 |
| Lium bal | ~$120,112 · floor $10k OK |
| submissions | 0 |
...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bg** prefetch cp1266 → chall+n80 |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **R3b** GRPO ~step12 sample/score |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R6** train ~35/96 @max_len16384 |
...
R2bg: `tail -f /root/logs/r2bg_cp1266_reload.log` · dec `r2bg_cp1266_decision.json`
...
**p2133:** R2bf REFUTE m=**−0.00206** z=−0.57 → armed **R2bg** `afgod1079/…-cp1266@68d1daa2` (chal-00514); B300×8=0; burn **$180.25/h**.
...
**Crown:** wait R2bg prefetch→n80 → `r2bg_cp1266_decision.json`.
