...
| B300 stock | **0** free 8×B300/B200 · fleet **parallel×8** @POLL=1s |
...
| name | huid | $/h | role |
|---|---|---|---|
| mine-crown-1 | gentle-orbit-bd | $52.25 | **R2bf** n80 ~45/80 dpo2@90ea78ff |
| mine-r3-grpo-1 | golden-hawk-ff | $64.00 | **R3b** GRPO sole pid**51672** @step3+ mean_r≈0.004 |
| mine-r4-fullft-1 | noble-orbit-9d | $64.00 | **R6** train ~14/96 @max_len16384 |
| host fleet-rent | pid**2700183** | — | **parallel×8** →R7/R8/R24–R29 @1s |
...
**p2130:** fleet×4→**parallel×8** (R7/R8/R24–R29); B300×8=0; burn still **$180.25/h**.

## Blocked
No free 8×B300/B200. Cannot hit $833/h burn until stock returns.

## Next action
**Rent:** snatch via parallel×8 (R7 first). Bootstrap auto-arms.
