...
| Lium / spend | **~$176,783** · cum ~$20,962 · **avail ~$166.8k** |
| miner burn | **~$31.92/h** (1) ≪$833 · free **19** |
| watch | `mine-f45-1` engines **200/200/200** · TTL **21:35Z (~0.23h)** |
...
1. If `mine-f45-1` **gone** (TTL **21:35Z**): rent **one** `mine-watch-1` 8×H200 ≤$32/h `--ttl 6h` by UUID (p1114 catalog verified 4/4):
