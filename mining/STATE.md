...
| Lium balance | ~$123,892 · floor ≥$10k · burn **$64/h** (≤$833/h ok) |
...
| R2d pure awesome-v6 | **RUNNING** · ~15/80 @22:28Z · pid **106493** / sim **121110** / chall **117592** |
| R2e Talent×awesome | **WAITING R2d** · pid **104742** · premerge Δ=**0.626** |
| R2f kevin×awesome | **CPU PREMERGE** · pid **122164** · waiter **122165** (after R2e) |

## What's running

| name | huid | SSH | TTL | role |
|---|---|---|---|---|
| mine-crown-1 | lunar-orbit-50 | `ssh root@86.38.182.50 -p 40300` | 2026-08-11T16:12Z | TK@65536 + R2d→R2e→R2f |
...
- R2f: CPU merge → `/root/r2_out/alpha_kevin_awesome_v6_skew` then waiter after R2e.
...
- Prefer R2d/R2e/R2f over Tok×awesome α (Δ≈0.006–0.009).
...
**Harvest** `/root/affine_data/r2d_awesome_decision.json`. If headroom ≥ 1.5× → Stage-5. Else let **R2e** then **R2f** (kevin×awesome) run; harvest `r2f_premerge.done` / Δ when CPU merge finishes.
