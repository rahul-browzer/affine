...
| R1b train | **RUNNING** · max_len=16384 · **~42/126** @~34s/it · loss~0.31 · pid **79866** |
...
| R2 prefetch | **RUNNING** · TalentPigs **OK**; kevin shard1 ~**28 GiB** incomplete · pid **83501** |
| R2 CPU premerge | **ARMED** · pid **85406** · waits prefetch → `/root/r2_out/alpha_tok_talent_kevin` |
| R2 α→n80 | **ARMED** · waiter pid **85408** · reuses premerge stamp if present |
...
|---|---|---|---|---|
| mine-crown-1 | lunar-orbit-50 | `ssh root@86.38.182.50 -p 40300` | 2026-08-11T16:12Z | TK@65536 + R1b + R1/R2 waiters + R2 prefetch/premerge |
...
- R2 prefetch: `/root/logs/r2_prefetch_parents.log` → `.done`.
...
- ETA R1b train ~0.8h; CPU α-merge overlaps; chall reload+n80 after R1c below bar.
...
**Harvest** `/root/affine_data/r1b_lora_decision.json` (and/or R1c / R2). If any clears 1.5× → Stage-5 prep. Else confirm R2 premerge.done then R2 α n80 (`r2_alpha_decision.json`).
