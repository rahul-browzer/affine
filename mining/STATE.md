...
| Lium | ~$122,344 · burn **$52.25/h** (≤$833/h) |
...
| warm | teacher/king/chall **200**; R2al pig n80 ~30/80 |
| R2ak | **DONE** local hr**0.641×** · board 470 hr**0.094×** — no Stage-5 |
| R2al | **RUNNING** pig n80 ~30/80 (pid30870) |
...
| name | SSH | role |
|---|---|---|
| mine-crown-1 | `ssh root@95.133.253.90 -p 40099` | TKC · R2al n80 · R2ab/R2ac wait · R2ad EAGER · watch471 |
...
**Poll** R2al → `r2al_pig_decision.json`. If hr≥1.5× → Stage-5. Else after R2al terminal confirm R2ab starts; stamp 471 when published → R2ad DONE or SKIP.
