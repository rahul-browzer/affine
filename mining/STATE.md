...
| Lium | ~$123,311 · burn **$64/h** (≤$833/h) · floor ≥$10k |
...
| **R2v** | pure sft3 **n80 RUNNING** · sim pid **194935** · 1/80 @02:49Z |
...
| name | SSH | role |
|---|---|---|
| mine-crown-1 | `ssh root@86.38.182.50 -p 40300` | TK@65536 · **R2v n80** · R2l…p+R2r wait |
...
**Harvest R2v** (`/root/affine_data/r2v_sft3_decision.json`): if hr≥1.5× → Stage-5 submit path; else keep R2l on 450 Reason+ / R2r on 458 (or next pure queue parent if board still idle).
