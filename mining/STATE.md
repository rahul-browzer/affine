...
(n80 sim RUNNING attempt 1/3, ~15/80).**
...
pid **276121** advancing king**15**/chall**15** @ 08:49:11Z
(~2.1–2.5 tpm window → ETA **~09:20Z**). Advancing. No submit.
...
| Lium balance | $33,784.50 (floor $28,000) |
| miner coldkey free | τ10.000 (unchanged) |
| mining spend to date | `mine-sim-1` spent **~$234** @ $23.60/h |
| our submissions | none |
| Stage 3 gate | **MET** |
| H2 / H1 / H1v2 / H5 merge | **all REFUTED** |
| H5b | **open** — n80 running (king15/chall15 @ 08:49Z; ETA ~09:20Z) |
...
- n80 sim pid **276121** (`run_sim_duel.py` attempt **1/3**); out
  ...
  `/root/affine_data/h5b_sim_progress.json` (king **15**/chall **15** @ 08:49:11Z)
- Rate: window ~2.13 k-tpm / 2.55 c-tpm → ETA **~09:20Z**; deadman slack OK
...
- Evidence: `results/h5b_sim_progress.json`, `h5b_time_budget_pass92.json`
...
Nothing hard. **Do not submit** H1/H1v2/H2/h5-kt*/h5b HF salvage. Cap remaining ~$3,766.
Ignore archived false abort. ETA n80 done ~09:20Z (window ~2.1–2.5 tpm; slack to deadman OK).
