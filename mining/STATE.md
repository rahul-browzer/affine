...
**F22,F26–F33 live** (9 pods). No submit. Best vs Tok: H81 +0.0088.
King Tok S=0.04456.
...
| Lium / spend | **~$180,642** · cum ~$17,098 · **avail ~$170.6k** |
| miner | τ10.000 free · 0 submissions |
| burn | **~$287.0/h** (9 mine-*) ≪ $833/h · free slots **11** |
| n80 | none mid-flight |
| other | F22 everest ~46G incomplete (growing); F26–F32 train; F33 pip |

## What's running

| name | huid | SSH | TTL | role |
|---|---|---|---|---|
| mine-f22-1 | calm-hawk-98 | 204.9.206.243:40300 | ~14:27Z | F22 everest ~46G incomplete (growing) |
...
| mine-f33-1 | golden-matrix-f1 | 3.135.191.208:20127 | ~17:07Z | F33 **pandora-FT pip** |
...
Open: H117/F22 + H121–**H128**/F26–**F33**. F5 needs traj.
...
1. Poll F26–F32 train.done → finalize+serve+n80. F33: pandora DL→full-FT.
2. F22 everest incomplete ~46G still growing — Range-resume **only if mtime freeze**.
3. Hold CONFIRM slots until a screen clears +0.015. Free slot → diane/everest/af-k1 dense-FT or F5 if traj.
